...
namespace Pokemod.Content.Items.Dyes
{
	public class DynamaxDye : ModItem
	{
		public override void SetStaticDefaults() {
			...
			if (!Main.dedServ) {
				...
				GameShaders.Armor.BindShader(
					Item.type,
					new ArmorShaderData(Mod.Assets.Request<Effect>("Assets/Effects/DynamaxEffect"), "DynamaxDyePass") // Be sure to update the effect path and pass name here.
				);
			}
