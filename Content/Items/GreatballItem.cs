...
namespace Pokemod.Content.Items
{
	...
	public class GreatballItem : ModItem
	{
	...
	public class ExampleCatchItemModification2 : GlobalItem
	{
		public override void OnSpawn(Item item, IEntitySource source) {
			...
			if (catchEntity.Entity is Player player) {
				...
				if (player.HeldItem.type == ModContent.ItemType<GreatballItem>() && Main.rand.NextBool(GreatballItem.BonusCritterChance, 100)) {
					item.stack *= 2;
				}
			}
		}
