...
namespace Pokemod.Content.Items.Armor
{
	...
	public class WaterStoneHelmet : ModItem
	{
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<WaterStoneBreastplate>() && legs.type == ModContent.ItemType<WaterStoneLeggings>();
		}
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient(ModContent.ItemType<WaterStoneItem>(), 7)
