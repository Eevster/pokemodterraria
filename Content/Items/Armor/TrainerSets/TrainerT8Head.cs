...
namespace Pokemod.Content.Items.Armor.TrainerSets
{
	// The AutoloadEquip attribute automatically attaches an equip texture to this item.
	// Providing the EquipType.Head value here will result in TML expecting a X_Head.png file to be placed next to the item's main texture.
	[AutoloadEquip(EquipType.Head)]
	public class TrainerT8Head : ModItem
	{
		public static readonly int AdditivePokemonCritBonus = 18;
		public static readonly int MaxPokemonIncrease = 3;
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<TrainerT8Body>() && legs.type == ModContent.ItemType<TrainerT8Legs>();
		}
