...
namespace Pokemod.Content.Items.Armor.TrainerSets
{
	...
	public class TrainerT7Head : ModItem
	{
		public static readonly int AdditivePokemonCritBonus = 15;
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<TrainerT7Body>() && legs.type == ModContent.ItemType<TrainerT7Legs>();
		}
