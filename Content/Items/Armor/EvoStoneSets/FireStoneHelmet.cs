...
namespace Pokemod.Content.Items.Armor.EvoStoneSets
{
	...
	public class FireStoneHelmet : ModItem
	{
		...
		public override void SetStaticDefaults() {
			...
			SetBonusText = this.GetLocalization("SetBonus").WithFormatArgs(AdditiveGenericDamageBonus, MaxManaIncrease);
		}
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<FireStoneBreastplate>() && legs.type == ModContent.ItemType<FireStoneLeggings>();
		}
