...
using Pokemod.Content.Pets.CharmanderPetShiny;
...
namespace Pokemod.Content.NPCs
{
	...
	/// </summary>
	public class CharmanderCritterNPCShiny : ModNPC
	{
		...
		public override void SetDefaults() {
			...
			NPC.catchItem = ModContent.ItemType<CharmanderPetItemShiny>();
			NPC.lavaImmune = true;
			AIType = ClonedNPCID;
        ...
        {
			NPC.GetGlobalNPC<PokemonNPCData>().SetPokemonNPCData("Charmander", true);
        }
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo) {
			return SpawnCondition.OverworldDay.Chance * 0.00025f;
		}
	...
	public class CharmanderCritterItemShiny : ModItem
	{
		public override void SetStaticDefaults() {
		...
		public override void SetDefaults() {
			...
			Item.makeNPC = ModContent.NPCType<CharmanderCritterNPCShiny>();
