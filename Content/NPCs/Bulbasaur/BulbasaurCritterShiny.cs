...
namespace Pokemod.Content.NPCs.Bulbasaur
{
    ...
    /// </summary>
    public class BulbasaurCritterNPCShiny : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.catchItem = ModContent.ItemType<BulbasaurPetItemShiny>();
            NPC.lavaImmune = true;
            AIType = ClonedNPCID;
        ...
        {
            NPC.GetGlobalNPC<PokemonNPCData>().SetPokemonNPCData("Bulbasaur", true);
        }
        ...
        {
            return SpawnCondition.SurfaceJungle.Chance * 0.00025f;
        }
    ...
    public class BulbasaurCritterItemShiny : ModItem
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
            ...
            Item.makeNPC = ModContent.NPCType<BulbasaurCritterNPCShiny>();
