...
namespace Pokemod.Content.NPCs.Eevee
{
    /// <summary>
    ...
    /// </summary>
    public class EeveeCritterNPCShiny : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.catchItem = ModContent.ItemType<EeveePetItem>();
            NPC.lavaImmune = true;
            AIType = ClonedNPCID;
    ...
    public class EeveeCritterItemShiny : ModItem
    {
        public override void SetStaticDefaults()
        {
