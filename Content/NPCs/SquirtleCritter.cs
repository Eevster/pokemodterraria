...
namespace Pokemod.Content.NPCs
{
	...
	/// </summary>
	public class SquirtleCritterNPC : ModNPC
	{
		...
		public override void SetDefaults() {
			...
			NPC.catchItem = ModContent.ItemType<SquirtlePetItem>();
			NPC.lavaImmune = true;
			AIType = ClonedNPCID;
        ...
        {
			NPC.GetGlobalNPC<PokemonNPCData>().SetPokemonNPCData("Squirtle");
        }
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo) {
			return SpawnCondition.BeachAngler.Chance * 0.1f;
		}
