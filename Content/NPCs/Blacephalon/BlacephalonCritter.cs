...
namespace Pokemod.Content.NPCs.Blacephalon
{
    /// <summary>
    ...
    /// </summary>
    public class BlacephalonCritterNPC : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.catchItem = ModContent.ItemType<CharmanderPetItem>();
            NPC.lavaImmune = true;
            AIType = ClonedNPCID;
        ...
        {
            // Check if the player is in the subworld and specify the spawn chance accordingly
            if (SubworldSystem.IsActive<IceUltraSpaceSubworld>() && spawnInfo.Player.ZoneSnow)
            {
                return 0.1f; // Adjust the spawn chance as needed
            }

            return 0f; // NPC won't spawn if conditions aren't met
        }
    ...
    public class BlacephalonCritterItem : ModItem
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
            ...
            Item.makeNPC = ModContent.NPCType<BlacephalonCritterNPC>();
