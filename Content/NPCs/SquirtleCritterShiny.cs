...
namespace Pokemod.Content.NPCs
{
	...
	/// </summary>
	public class SquirtleCritterNPCShiny : ModNPC
	{
		...
		public override void SetDefaults() {
			...
			NPC.catchItem = ModContent.ItemType<SquirtlePetItemShiny>();
			NPC.lavaImmune = true;
			AIType = ClonedNPCID;
        ...
        {
			NPC.GetGlobalNPC<PokemonNPCData>().SetPokemonNPCData("Squirtle", true);
        }
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo) {
			return SpawnCondition.BeachAngler.Chance * 0.00025f;
		}
	...
	public class SquirtleCritterItemShiny : ModItem
	{
		public override void SetStaticDefaults() {
		...
		public override void SetDefaults() {
			...
			Item.makeNPC = ModContent.NPCType<SquirtleCritterNPCShiny>();
