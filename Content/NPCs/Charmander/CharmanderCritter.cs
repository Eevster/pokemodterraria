...
namespace Pokemod.Content.NPCs.Charmander
{
    /// <summary>
    ...
    /// </summary>
    public class CharmanderCritterNPC : ModNPC
    {
        ...
        {
            NPC.GetGlobalNPC<PokemonNPCData>().SetPokemonNPCData("Charmander");
        }
        ...
        {
            return SpawnCondition.OverworldDayDesert.Chance * 100f;
        }
    ...
    public class CharmanderCritterItem : ModItem
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
            ...
            Item.makeNPC = ModContent.NPCType<CharmanderCritterNPC>();
