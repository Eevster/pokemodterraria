...
{
	public class AlolanDiglettCritterNPC : PokemonWildNPC
	{
        ...
        {
			npcLoot.Add(ItemDropRule.Common(ItemID.IronOre, 3, 3, 9));
            base.ModifyNPCLoot(npcLoot);
        }
	}

	public class AlolanDiglettCritterNPCShiny : AlolanDiglettCritterNPC{}
}