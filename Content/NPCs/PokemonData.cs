...
namespace Pokemod.Content.NPCs
{
    internal class PokemonNPCData : GlobalNPC
    {
        ...
        {
            string[] statColors = ["#87FA34", "#FADC34", "#F7931B", "#23CCD9", "#2357D9", "#CA23D9"];
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Charizard", new PokemonInfo(0006,[78, 84, 78, 109, 85, 100], [(int)TypeIndex.Fire,(int)TypeIndex.Flying], [new MoveLvl("AirSlash"), new MoveLvl("Tackle", 1), new MoveLvl("Ember", 1), new MoveLvl("Smokescreen", 1), new MoveLvl("DragonBreath", 12), new MoveLvl("Slash", 24), new MoveLvl("Flamethrower", 30), new MoveLvl("FlameWheel", 46), new MoveLvl("FireBlast", 62)], [(int)EggGroups.Monster, (int)EggGroups.Dragon], 1.7f, 90.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},

            {"Squirtle", new PokemonInfo(0007,[44, 48, 65, 50, 64, 43], [(int)TypeIndex.Water], [new MoveLvl("Tackle"), new MoveLvl("WaterGun", 3), new MoveLvl("WaterPulse", 12), new MoveLvl("Crunch", 15), new MoveLvl("Harden", 18), new MoveLvl("BubbleBeam", 24), new MoveLvl("Waterfall", 30), new MoveLvl("HydroPump", 33), new MoveLvl("DoubleEdge", 36)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 0.5f, 9.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Wartortle", new PokemonInfo(0008, [59, 63, 80, 65, 80, 58], [(int)TypeIndex.Water], [new MoveLvl("Tackle", 1), new MoveLvl("WaterGun", 1), new MoveLvl("WaterPulse", 12), new MoveLvl("Crunch", 15), new MoveLvl("Harden", 20), new MoveLvl("BubbleBeam", 30), new MoveLvl("Waterfall", 40), new MoveLvl("HydroPump", 45), new MoveLvl("DoubleEdge", 50)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 1.0f, 22.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Blastoise", new PokemonInfo(0009, [79, 83, 100, 85, 105, 78], [(int)TypeIndex.Water], [new MoveLvl("FlashCannon"), new MoveLvl("Tackle", 1), new MoveLvl("WaterGun", 1), new MoveLvl("WaterPulse", 12), new MoveLvl("Crunch", 15), new MoveLvl("Harden", 20), new MoveLvl("BubbleBeam", 30), new MoveLvl("Waterfall", 42), new MoveLvl("HydroPump", 49), new MoveLvl("DoubleEdge", 56)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 1.6f, 85.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},

            {"Caterpie", new PokemonInfo(0010, [45, 30, 35, 20, 20, 45], [(int)TypeIndex.Bug], [new MoveLvl("Tackle"), new MoveLvl("StringShot")], [(int)EggGroups.Bug], 0.3f, 2.9f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Metapod", new PokemonInfo(0011, [50, 20, 55, 25, 25, 30], [(int)TypeIndex.Bug], [new MoveLvl("Harden")], [(int)EggGroups.Bug], 0.7f, 9.9f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            {"Butterfree", new PokemonInfo(0012, [60, 45, 50, 90, 80, 70], [(int)TypeIndex.Bug,(int)TypeIndex.Flying], [new MoveLvl("Confusion"), new MoveLvl("Gust"), new MoveLvl("Harden", 1), new MoveLvl("StringShot", 1), new MoveLvl("PoisonPowder", 12), new MoveLvl("Psybeam", 16), new MoveLvl("AirSlash", 24)], [(int)EggGroups.Bug], 1.1f, 32.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumFast)},

            {"Weedle", new PokemonInfo(0013, [40, 35, 30, 20, 20, 50], [(int)TypeIndex.Bug,(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("StringShot")], [(int)EggGroups.Bug], 0.3f, 3.2f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Kakuna", new PokemonInfo(0014, [45, 25, 50, 25, 25, 35], [(int)TypeIndex.Bug,(int)TypeIndex.Poison], [new MoveLvl("Harden")], [(int)EggGroups.Bug], 0.6f, 10.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            {"Beedrill", new PokemonInfo(0015, [65, 90, 40, 45, 80, 75], [(int)TypeIndex.Bug,(int)TypeIndex.Poison], [new MoveLvl("FuryCutter"), new MoveLvl("QuickAttack"), new MoveLvl("Harden", 1), new MoveLvl("StringShot", 1), new MoveLvl("PoisonSting", 17), new MoveLvl("PinMissile", 32), new MoveLvl("SludgeBomb", 35)], [(int)EggGroups.Bug], 1.0f, 29.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumFast)},

            {"Pidgey", new PokemonInfo(0016, [40, 45, 40, 35, 35, 56], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("Tackle"), new MoveLvl("Gust", 9), new MoveLvl("QuickAttack", 13), new MoveLvl("WingAttack", 33), new MoveLvl("AirSlash", 49)], [(int)EggGroups.Flying], 0.3f, 1.8f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Pidgeotto", new PokemonInfo(0017, [63, 60, 55, 50, 50, 71], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("QuickAttack", 13), new MoveLvl("WingAttack", 37), new MoveLvl("AirSlash", 57)], [(int)EggGroups.Flying], 1.1f, 30.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Pidgeot", new PokemonInfo(0018, [83, 80, 75, 70, 70, 101], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("WingAttack", 38), new MoveLvl("AirSlash", 62)], [(int)EggGroups.Flying], 1.5f, 39.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},

            {"Rattata", new PokemonInfo(0019, [30, 56, 35, 25, 35, 72], [(int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("QuickAttack", 4), new MoveLvl("Crunch", 22), new MoveLvl("HyperFang", 28), new MoveLvl("DoubleEdge", 31)], [(int)EggGroups.Field], 0.3f, 3.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Raticate", new PokemonInfo(0020, [55, 81, 60, 50, 70, 97], [(int)TypeIndex.Normal], [new MoveLvl("Tackle", 1), new MoveLvl("QuickAttack", 4), new MoveLvl("Crunch", 24), new MoveLvl("HyperFang", 34), new MoveLvl("DoubleEdge", 39)], [(int)EggGroups.Field], 0.7f, 18.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},

            {"Spearow", new PokemonInfo(0021, [40, 60, 30, 31, 31, 70], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("Gust")], [(int)EggGroups.Flying], 0.3f, 2.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Fearow", new PokemonInfo(0022, [65, 90, 65, 61, 61, 100], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("WingAttack")], [(int)EggGroups.Flying], 1.2f, 38.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Pikachu", new PokemonInfo(0025, [35, 55, 40, 50, 50, 90], [(int)TypeIndex.Electric], [new MoveLvl("Tackle"), new MoveLvl("ThunderWave", 4), new MoveLvl("QuickAttack", 8), new MoveLvl("ElectroBall", 12), new MoveLvl("Swift", 20), new MoveLvl("Discharge", 28), new MoveLvl("Thunderbolt", 36), new MoveLvl("Thunder", 44)], [(int)EggGroups.Field, (int)EggGroups.Fairy], 0.4f, 6.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Raichu", new PokemonInfo(0026, [60, 90, 55, 90, 80, 110], [(int)TypeIndex.Electric], [new MoveLvl("Thunderbolt"), new MoveLvl("QuickAttack", 1), new MoveLvl("ElectroBall", 1), new MoveLvl("Discharge", 1)], [(int)EggGroups.Field, (int)EggGroups.Fairy], 0.8f, 30.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},

            {"Sandshrew", new PokemonInfo(0027, [50, 75, 85, 20, 30, 40], [(int)TypeIndex.Ground], [new MoveLvl("QuickAttack")], [(int)EggGroups.Field], 0.6f, 12.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Sandslash", new PokemonInfo(0028, [75, 100, 110, 45, 55, 65], [(int)TypeIndex.Ground], [new MoveLvl("Dig"), new MoveLvl("MudShot")], [(int)EggGroups.Field], 1.0f, 29.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},

            {"NidoranF", new PokemonInfo(0029, [46, 57, 40, 40, 40, 50], [(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("DoubleKick", 25), new MoveLvl("Toxic", 40), new MoveLvl("Crunch", 50), new MoveLvl("Earthquake", 55)], [(int)EggGroups.Monster, (int)EggGroups.Field], 0.4f, 7.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Nidorina", new PokemonInfo(0030, [70, 62, 67, 55, 55, 56], [(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("DoubleKick", 29), new MoveLvl("Toxic", 50), new MoveLvl("Crunch", 64), new MoveLvl("Earthquake", 71)], [(int)EggGroups.NoEggs], 0.8f, 20.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Nidoqueen", new PokemonInfo(0031, [90, 92, 87, 75, 85, 76], [(int)TypeIndex.Poison,(int)TypeIndex.Ground], [new MoveLvl("Toxic"), new MoveLvl("Crunch"), new MoveLvl("Earthquake", 43), new MoveLvl("FocusPunch", 58)], [(int)EggGroups.NoEggs], 1.3f, 60.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},

            {"NidoranM", new PokemonInfo(0032, [55, 47, 52, 40, 40, 41], [(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("DoubleKick", 25), new MoveLvl("Toxic", 40), new MoveLvl("SludgeBomb", 50), new MoveLvl("Earthquake", 55)], [(int)EggGroups.Monster, (int)EggGroups.Field], 0.5f, 9.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Nidorino", new PokemonInfo(0033, [61, 72, 57, 55, 55, 65], [(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("DoubleKick", 29), new MoveLvl("Toxic", 50), new MoveLvl("SludgeBomb", 64), new MoveLvl("Earthquake", 71)], [(int)EggGroups.Monster, (int)EggGroups.Field], 0.9f, 19.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Nidoking", new PokemonInfo(0034, [81, 102, 77, 85, 75, 85], [(int)TypeIndex.Poison,(int)TypeIndex.Ground], [new MoveLvl("Toxic"), new MoveLvl("SludgeBomb"), new MoveLvl("Earthquake", 43), new MoveLvl("FocusPunch", 58)], [(int)EggGroups.Monster, (int)EggGroups.Field], 1.4f, 62.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},

            {"Clefairy", new PokemonInfo(0035, [70, 45, 48, 60, 65, 35], [(int)TypeIndex.Fairy], [new MoveLvl("Tackle")], [(int)EggGroups.Fairy], 0.6f, 7.5f, (int)StageIndex.Basic, (int)ExpTypes.Fast, completed: false)},
            {"Clefable", new PokemonInfo(0036, [95, 70, 73, 95, 90, 60], [(int)TypeIndex.Fairy], [new MoveLvl("HealPulse"), new MoveLvl("Tackle")], [(int)EggGroups.Fairy], 1.3f, 40.0f, (int)StageIndex.Stage1, (int)ExpTypes.Fast, completed: false)},
            ...
            {"Jigglypuff", new PokemonInfo(0039, [115, 45, 20, 45, 25, 20], [(int)TypeIndex.Normal,(int)TypeIndex.Fairy], [new MoveLvl("Tackle")], [(int)EggGroups.Fairy], 0.5f, 5.5f, (int)StageIndex.Basic, (int)ExpTypes.Fast, completed: false)},
            {"Wigglytuff", new PokemonInfo(0040, [140, 70, 45, 85, 50, 45], [(int)TypeIndex.Normal,(int)TypeIndex.Fairy], [new MoveLvl("DoubleEdge"), new MoveLvl("Swift")], [(int)EggGroups.Fairy], 1.0f, 12.0f, (int)StageIndex.Stage1, (int)ExpTypes.Fast, completed: false)},

            {"Zubat", new PokemonInfo(0041, [40, 45, 35, 30, 40, 55], [(int)TypeIndex.Poison,(int)TypeIndex.Flying], [new MoveLvl("ConfuseRay")], [(int)EggGroups.Flying], 0.8f, 7.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Golbat", new PokemonInfo(0042, [75, 80, 70, 65, 75, 90], [(int)TypeIndex.Poison,(int)TypeIndex.Flying], [new MoveLvl("AirSlash")], [(int)EggGroups.Flying], 1.6f, 55.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},

            {"Oddish",new PokemonInfo(0043, [45, 50, 55, 75, 65, 30], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [new MoveLvl("RazorLeaf")], [(int)EggGroups.Grass], 0.5f, 5.4f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, completed: false)},
            ...
            {"Paras", new PokemonInfo(0046, [35, 70, 55, 45, 55, 25], [(int)TypeIndex.Bug,(int)TypeIndex.Grass], [new MoveLvl("Tackle"), new MoveLvl("PoisonPowder", 6), new MoveLvl("VineWhip", 11), new MoveLvl("FuryCutter", 17), new MoveLvl("Slash", 27), new MoveLvl("GigaDrain", 38), new MoveLvl("LeafBlade", 49)], [(int)EggGroups.Bug, (int)EggGroups.Grass], 0.3f, 5.4f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Parasect", new PokemonInfo(0047, [60, 95, 80, 60, 80, 30], [(int)TypeIndex.Bug,(int)TypeIndex.Grass], [new MoveLvl("Tackle", 1), new MoveLvl("PoisonPowder", 6), new MoveLvl("VineWhip", 11), new MoveLvl("FuryCutter", 17), new MoveLvl("Slash", 29), new MoveLvl("GigaDrain", 44), new MoveLvl("LeafBlade", 59)], [(int)EggGroups.Bug, (int)EggGroups.Grass], 1.0f, 29.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},

            {"Venonat", new PokemonInfo(0048, [60, 55, 50, 40, 55, 45], [(int)TypeIndex.Bug,(int)TypeIndex.Poison], [new MoveLvl("Confusion")], [(int)EggGroups.Bug], 1.0f, 30.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Venomoth", new PokemonInfo(0049, [70, 65, 60, 90, 75, 90], [(int)TypeIndex.Bug,(int)TypeIndex.Poison], [new MoveLvl("Psychic")], [(int)EggGroups.Bug], 1.5f, 12.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},

            {"Diglett", new PokemonInfo(0050, [10, 55, 25, 35, 45, 95], [(int)TypeIndex.Ground], [new MoveLvl("Tackle"), new MoveLvl("MudShot", 9), new MoveLvl("Dig", 17), new MoveLvl("RockThrow", 25), new MoveLvl("Slash", 33), new MoveLvl("Earthquake", 41)], [(int)EggGroups.Field], 0.2f, 0.8f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Dugtrio", new PokemonInfo(0051, [35, 100, 50, 50, 70, 120], [(int)TypeIndex.Ground], [new MoveLvl("Tackle", 1), new MoveLvl("MudShot", 9), new MoveLvl("Dig", 17), new MoveLvl("RockThrow", 25), new MoveLvl("Slash", 37), new MoveLvl("Earthquake", 49)], [(int)EggGroups.Field], 0.7f, 33.3f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},

            {"Meowth", new PokemonInfo(0052, [40, 45, 35, 40, 40, 90], [(int)TypeIndex.Normal], [new MoveLvl("Tackle")], [(int)EggGroups.Field], 0.4f, 4.2f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Persian", new PokemonInfo(0053, [65, 70, 60, 65, 65, 115], [(int)TypeIndex.Normal], [new MoveLvl("HyperFang")], [(int)EggGroups.Field], 1.0f, 32.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},

            {"Psyduck", new PokemonInfo(0054, [50, 52, 48, 65, 50, 55], [(int)TypeIndex.Water], [new MoveLvl("Tackle"), new MoveLvl("WaterGun", 3), new MoveLvl("Confusion", 6), new MoveLvl("WaterPulse", 12), new MoveLvl("PsychoCut", 18), new MoveLvl("Waterfall", 24), new MoveLvl("ConfuseRay", 30), new MoveLvl("HydroPump", 36)], [(int)EggGroups.Water1, (int)EggGroups.Field], 0.8f, 19.6f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Golduck", new PokemonInfo(0055, [80, 82, 78, 95, 80, 85], [(int)TypeIndex.Water], [new MoveLvl("Tackle", 1), new MoveLvl("WaterGun", 1), new MoveLvl("Confusion", 1), new MoveLvl("WaterPulse", 12), new MoveLvl("PsychoCut", 18), new MoveLvl("Waterfall", 24), new MoveLvl("ConfuseRay", 30), new MoveLvl("HydroPump", 40)], [(int)EggGroups.Water1, (int)EggGroups.Field], 1.7f, 76.6f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},

            {"Mankey", new PokemonInfo(0056, [40, 80, 35, 35, 45, 70], [(int)TypeIndex.Fighting], [new MoveLvl("Tackle")], [(int)EggGroups.Field], 0.5f, 28.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Primeape", new PokemonInfo(0057, [65, 105, 60, 60, 70, 95], [(int)TypeIndex.Fighting], [new MoveLvl("DoubleKick")], [(int)EggGroups.Field], 1.0f, 32.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Poliwag", new PokemonInfo(0060, [40, 50, 40, 40, 40, 90], [(int)TypeIndex.Water], [new MoveLvl("WaterGun"), new MoveLvl("Tackle"), new MoveLvl("MudShot", 12), new MoveLvl("BubbleBeam", 18), new MoveLvl("Earthquake", 36), new MoveLvl("HydroPump", 42), new MoveLvl("DoubleEdge", 54)], [(int)EggGroups.Water1], 0.6f, 12.4f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Poliwhirl", new PokemonInfo(0061, [65, 65, 65, 50, 50, 90], [(int)TypeIndex.Water], [new MoveLvl("WaterGun", 1), new MoveLvl("MudShot", 1), new MoveLvl("BubbleBeam", 1), new MoveLvl("Earthquake", 40), new MoveLvl("HydroPump", 48), new MoveLvl("DoubleEdge", 66)], [(int)EggGroups.Water1], 1.0f, 20.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Poliwrath", new PokemonInfo(0062, [90, 95, 95, 70, 90, 70], [(int)TypeIndex.Water,(int)TypeIndex.Fighting], [new MoveLvl("HydroPump"),new MoveLvl("FocusPunch")], [(int)EggGroups.Water1], 1.3f, 54.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},

            {"Abra", new PokemonInfo(0063, [25, 20, 15, 105, 55, 90], [(int)TypeIndex.Psychic], [new MoveLvl("Teleport")], [(int)EggGroups.HumanLike], 0.9f, 19.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Kadabra", new PokemonInfo(0064, [40, 35, 30, 120, 70, 105], [(int)TypeIndex.Psychic], [new MoveLvl("Confusion"), new MoveLvl("Teleport"), new MoveLvl("Psybeam", 24), new MoveLvl("HealPulse", 30), new MoveLvl("PsychoCut", 34), new MoveLvl("Psychic", 40)], [(int)EggGroups.HumanLike], 1.3f, 56.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Alakazam", new PokemonInfo(0065, [55, 50, 45, 135, 95, 120], [(int)TypeIndex.Psychic], [new MoveLvl("Confusion", 1), new MoveLvl("Teleport", 1), new MoveLvl("Psybeam", 24), new MoveLvl("HealPulse", 30), new MoveLvl("PsychoCut", 34), new MoveLvl("Psychic", 40)], [(int)EggGroups.HumanLike], 1.5f, 48.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},

            {"Machop", new PokemonInfo(0066, [70, 80, 50, 35, 35, 35], [(int)TypeIndex.Fighting], [new MoveLvl("Tackle"), new MoveLvl("QuickAttack", 8), new MoveLvl("DoubleKick", 16), new MoveLvl("FlameWheel", 24), new MoveLvl("Earthquake", 32), new MoveLvl("DoubleEdge", 40), new MoveLvl("FocusPunch", 48)], [(int)EggGroups.HumanLike], 0.8f, 19.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Machoke", new PokemonInfo(0067, [80, 100, 70, 50, 60, 45], [(int)TypeIndex.Fighting], [new MoveLvl("Tackle", 1), new MoveLvl("QuickAttack", 8), new MoveLvl("DoubleKick", 16), new MoveLvl("FlameWheel", 24), new MoveLvl("Earthquake", 34), new MoveLvl("DoubleEdge", 46), new MoveLvl("FocusPunch", 58)], [(int)EggGroups.HumanLike], 1.5f, 70.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Machamp", new PokemonInfo(0068, [90, 130, 80, 65, 85, 55], [(int)TypeIndex.Fighting], [new MoveLvl("Harden"), new MoveLvl("Tackle", 1), new MoveLvl("QuickAttack", 8), new MoveLvl("DoubleKick", 16), new MoveLvl("FlameWheel", 24), new MoveLvl("Earthquake", 34), new MoveLvl("DoubleEdge", 46), new MoveLvl("FocusPunch", 58)], [(int)EggGroups.HumanLike], 1.6f, 130.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},

            {"Bellsprout", new PokemonInfo(0069, [50, 75, 35, 70, 30, 40], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [new MoveLvl("VineWhip"), new MoveLvl("PoisonPowder", 12), new MoveLvl("ThunderWave", 17), new MoveLvl("PoisonSting", 23), new MoveLvl("Crunch", 29), new MoveLvl("RazorLeaf", 39), new MoveLvl("SludgeBomb", 41)], [(int)EggGroups.Grass], 0.7f, 4.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Weepinbell", new PokemonInfo(0070, [65, 90, 50, 85, 45, 55], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [new MoveLvl("VineWhip", 1), new MoveLvl("PoisonPowder", 12), new MoveLvl("ThunderWave", 17), new MoveLvl("PoisonSting", 24), new MoveLvl("Crunch", 32), new MoveLvl("RazorLeaf", 44), new MoveLvl("SludgeBomb", 47)], [(int)EggGroups.Grass], 1.0f, 6.4f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Victreebel", new PokemonInfo(0071, [80, 105, 65, 100, 70, 70], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [new MoveLvl("BulletSeed"), new MoveLvl("VineWhip", 1), new MoveLvl("PoisonPowder", 1), new MoveLvl("PoisonSting", 1), new MoveLvl("LeafStorm", 32), new MoveLvl("LeafBlade", 44)], [(int)EggGroups.Grass], 1.7f, 15.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},

            {"Tentacool", new PokemonInfo(0072, [40, 40, 35, 50, 100, 70], [(int)TypeIndex.Water,(int)TypeIndex.Poison], [new MoveLvl("Bubble")], [(int)EggGroups.Water3], 0.9f, 45.5f, (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Tentacruel", new PokemonInfo(0073, [80, 70, 65, 80, 120, 100], [(int)TypeIndex.Water,(int)TypeIndex.Poison], [new MoveLvl("PoisonSting")], [(int)EggGroups.Water3], 1.6f, 55.0f, (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},

            {"Geodude", new PokemonInfo(0074, [40, 80, 100, 30, 30, 20], [(int)TypeIndex.Rock,(int)TypeIndex.Ground], [new MoveLvl("Tackle"), new MoveLvl("RockThrow", 10), new MoveLvl("Harden", 16), new MoveLvl("MudShot", 22), new MoveLvl("SelfDestruct", 26), new MoveLvl("Dig", 30), new MoveLvl("Earthquake", 34), new MoveLvl("Explosion", 38), new MoveLvl("DoubleEdge", 42)], [(int)EggGroups.Mineral], 0.4f, 20.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Graveler", new PokemonInfo(0075, [55, 95, 115, 45, 45, 35], [(int)TypeIndex.Rock,(int)TypeIndex.Ground], [new MoveLvl("Tackle", 1), new MoveLvl("RockThrow", 10), new MoveLvl("Harden", 16), new MoveLvl("MudShot", 22), new MoveLvl("SelfDestruct", 28), new MoveLvl("Dig", 34), new MoveLvl("Earthquake", 40), new MoveLvl("Explosion", 44), new MoveLvl("DoubleEdge", 50)], [(int)EggGroups.Mineral], 1.0f, 105.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Golem", new PokemonInfo(0076, [80, 120, 130, 55, 65, 45], [(int)TypeIndex.Rock,(int)TypeIndex.Ground], [new MoveLvl("Tackle", 1), new MoveLvl("RockThrow", 10), new MoveLvl("Harden", 16), new MoveLvl("MudShot", 22), new MoveLvl("SelfDestruct", 28), new MoveLvl("Dig", 34), new MoveLvl("Earthquake", 40), new MoveLvl("Explosion", 44), new MoveLvl("DoubleEdge", 50)], [(int)EggGroups.Mineral], 1.4f, 300.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            ...
            {"Slowpoke", new PokemonInfo(0079, [90, 65, 65, 40, 40, 15], [(int)TypeIndex.Water,(int)TypeIndex.Psychic], [new MoveLvl("Confusion")], [(int)EggGroups.Monster, (int)EggGroups.Water1], 1.2f, 36.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Slowbro", new PokemonInfo(0080, [95, 75, 110, 100, 80, 30], [(int)TypeIndex.Water,(int)TypeIndex.Psychic], [new MoveLvl("ConfuseRay")], [(int)EggGroups.Monster, (int)EggGroups.Water1], 1.6f, 78.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},

            {"Magnemite", new PokemonInfo(0081, [25, 35, 70, 95, 55, 45], [(int)TypeIndex.Electric,(int)TypeIndex.Steel], [new MoveLvl("Tackle"), new MoveLvl("ConfuseRay", 4), new MoveLvl("ThunderWave", 8), new MoveLvl("ElectroBall", 12), new MoveLvl("Swift", 20), new MoveLvl("FlashCannon", 28), new MoveLvl("Discharge", 36), new MoveLvl("Thunder", 44)], [(int)EggGroups.Mineral], 0.3f, 6.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"Seel", new PokemonInfo(0086, [65, 45, 55, 45, 70, 45], [(int)TypeIndex.Water], [new MoveLvl("WaterGun")], [(int)EggGroups.Water1, (int)EggGroups.Field], 1.1f, 90.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Dewgong", new PokemonInfo(0087, [90, 70, 80, 70, 95, 70], [(int)TypeIndex.Water,(int)TypeIndex.Ice], [new MoveLvl("IceFang")], [(int)EggGroups.Water1, (int)EggGroups.Field], 1.7f, 120.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},

            {"Grimer", new PokemonInfo(0088, [80, 80, 50, 40, 50, 25], [(int)TypeIndex.Poison], [new MoveLvl("MudShot")], [(int)EggGroups.Amorphous], 0.9f, 30.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Muk", new PokemonInfo(0089, [105, 105, 75, 65, 100, 50], [(int)TypeIndex.Poison], [new MoveLvl("SludgeBomb")], [(int)EggGroups.Amorphous], 1.2f, 30.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},

            {"Shellder", new PokemonInfo(0090, [30, 65, 100, 45, 25, 40], [(int)TypeIndex.Water], [new MoveLvl("Tackle"), new MoveLvl("Bubble", 8), new MoveLvl("WaterGun", 12), new MoveLvl("Harden", 20), new MoveLvl("BubbleBeam", 28), new MoveLvl("Slash", 36), new MoveLvl("Waterfall", 44), new MoveLvl("HydroPump", 52)], [(int)EggGroups.Water3], 0.3f, 4.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow)},
            {"Cloyster", new PokemonInfo(0091, [50, 95, 180, 85, 45, 70], [(int)TypeIndex.Water,(int)TypeIndex.Ice], [new MoveLvl("IceFang"), new MoveLvl("Tackle", 1), new MoveLvl("Bubble", 8), new MoveLvl("WaterGun", 12), new MoveLvl("Harden", 20), new MoveLvl("BubbleBeam", 28), new MoveLvl("Slash", 36), new MoveLvl("Waterfall", 44), new MoveLvl("HydroPump", 52)], [(int)EggGroups.Water3], 1.5f, 132.5f, (int)StageIndex.Stage1, (int)ExpTypes.Slow)},

            {"Gastly", new PokemonInfo(0092, [30, 35, 30, 100, 35, 80], [(int)TypeIndex.Ghost,(int)TypeIndex.Poison], [new MoveLvl("ConfuseRay"), new MoveLvl("Confusion", 12), new MoveLvl("Hex", 20), new MoveLvl("NightShade", 28), new MoveLvl("Crunch", 34), new MoveLvl("ShadowBall", 40)], [(int)EggGroups.Amorphous], 1.3f, 0.1f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Haunter", new PokemonInfo(0093, [45, 50, 45, 115, 55, 95], [(int)TypeIndex.Ghost,(int)TypeIndex.Poison], [new MoveLvl("Toxic"), new MoveLvl("ConfuseRay", 1), new MoveLvl("Confusion", 12), new MoveLvl("Hex", 20), new MoveLvl("NightShade", 32), new MoveLvl("Crunch", 40), new MoveLvl("ShadowBall", 48)], [(int)EggGroups.Amorphous], 1.6f, 0.1f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Gengar", new PokemonInfo(0094, [60, 65, 60, 130, 75, 110], [(int)TypeIndex.Ghost,(int)TypeIndex.Poison], [new MoveLvl("Toxic", 1), new MoveLvl("ConfuseRay", 1), new MoveLvl("Confusion", 12), new MoveLvl("Hex", 20), new MoveLvl("NightShade", 32), new MoveLvl("Crunch", 40), new MoveLvl("ShadowBall", 48)], [(int)EggGroups.Amorphous], 1.5f, 40.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},

            {"Onix", new PokemonInfo(0095, [35, 45, 160, 30, 45, 70], [(int)TypeIndex.Rock,(int)TypeIndex.Ground], [new MoveLvl("Tackle"), new MoveLvl("Harden"), new MoveLvl("RockThrow", 8), new MoveLvl("DragonBreath", 12), new MoveLvl("MudShot", 20), new MoveLvl("Dig", 30), new MoveLvl("FlashCannon", 40), new MoveLvl("Earthquake", 48), new MoveLvl("DoubleEdge", 56)], [(int)EggGroups.Mineral], 8.8f, 210.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"Krabby", new PokemonInfo(0098, [30, 105, 90, 25, 25, 50], [(int)TypeIndex.Water], [new MoveLvl("Bubble")], [(int)EggGroups.Water3], 0.4f, 6.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Kingler", new PokemonInfo(0099, [55, 130, 115, 50, 50, 75], [(int)TypeIndex.Water], [new MoveLvl("WaterPulse")], [(int)EggGroups.Water3], 1.3f, 60.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Cubone", new PokemonInfo(0104, [50, 50, 95, 40, 50, 35], [(int)TypeIndex.Ground], [new MoveLvl("Tackle"), new MoveLvl("MudShot", 8), new MoveLvl("QuickAttack", 16), new MoveLvl("Dig", 24), new MoveLvl("Slash", 32), new MoveLvl("DoubleEdge", 40), new MoveLvl("Earthquake", 48)], [(int)EggGroups.Monster], 0.4f, 6.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Marowak", new PokemonInfo(0105, [60, 80, 110, 50, 80, 45], [(int)TypeIndex.Ground], [new MoveLvl("Tackle", 1), new MoveLvl("MudShot", 8), new MoveLvl("QuickAttack", 16), new MoveLvl("Dig", 24), new MoveLvl("Slash", 34), new MoveLvl("DoubleEdge", 44), new MoveLvl("Earthquake", 54)], [(int)EggGroups.Monster], 1.0f, 45.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            ...
            {"Hitmonchan", new PokemonInfo(0107, [50, 105, 79, 35, 110, 76], [(int)TypeIndex.Fighting], [new MoveLvl("DoubleKick")], [(int)EggGroups.HumanLike], 1.4f, 50.2f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},

            {"Lickitung", new PokemonInfo(0108, [90, 55, 75, 60, 75, 30], [(int)TypeIndex.Normal], [new MoveLvl("Tackle")], [(int)EggGroups.Monster], 1.2f, 65.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},

            {"Koffing", new PokemonInfo(0109, [40, 65, 95, 60, 45, 35], [(int)TypeIndex.Poison], [new MoveLvl("Tackle"), new MoveLvl("PoisonPowder"), new MoveLvl("Smokescreen", 8), new MoveLvl("Crunch", 16), new MoveLvl("SelfDestruct", 24), new MoveLvl("SludgeBomb", 32), new MoveLvl("Toxic", 36), new MoveLvl("Explosion", 44)], [(int)EggGroups.Amorphous], 0.6f, 1.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Weezing", new PokemonInfo(0110, [65, 90, 120, 85, 70, 60], [(int)TypeIndex.Poison], [new MoveLvl("DoubleKick"), new MoveLvl("Tackle", 1), new MoveLvl("PoisonPowder", 1), new MoveLvl("Smokescreen", 8), new MoveLvl("Crunch", 16), new MoveLvl("SelfDestruct", 24), new MoveLvl("SludgeBomb", 32), new MoveLvl("Toxic", 38), new MoveLvl("Explosion", 50)], [(int)EggGroups.Amorphous], 1.2f, 9.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},

            {"Rhyhorn", new PokemonInfo(0111, [80, 85, 95, 30, 30, 25], [(int)TypeIndex.Ground,(int)TypeIndex.Rock], [new MoveLvl("Tackle")], [(int)EggGroups.Monster, (int)EggGroups.Field], 1.0f, 115.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Rhydon", new PokemonInfo(0112, [105, 130, 120, 45, 45, 40], [(int)TypeIndex.Ground,(int)TypeIndex.Rock], [new MoveLvl("RockThrow"), new MoveLvl("Earthquake")], [(int)EggGroups.Monster, (int)EggGroups.Field], 1.9f, 120.0f, (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},
            ...
            {"Tangela", new PokemonInfo(0114, [65, 55, 115, 100, 40, 60], [(int)TypeIndex.Grass], [new MoveLvl("VineWhip"), new MoveLvl("MegaDrain", 8) , new MoveLvl("PoisonPowder", 16), new MoveLvl("AncientPower", 24), new MoveLvl("GigaDrain", 32), new MoveLvl("LeafBlade", 40), new MoveLvl("LeafStorm", 48)], [(int)EggGroups.Grass], 1.0f, 35.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"Jynx", new PokemonInfo(0124, [65, 50, 35, 115, 95, 95], [(int)TypeIndex.Ice,(int)TypeIndex.Psychic], [new MoveLvl("IceFang")], [(int)EggGroups.HumanLike], 1.4f, 40.6f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Electabuzz", new PokemonInfo(0125, [65, 83, 57, 95, 85, 105], [(int)TypeIndex.Electric], [new MoveLvl("Thunder")], [(int)EggGroups.HumanLike], 1.1f, 30.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Magmar", new PokemonInfo(0126, [65, 95, 57, 100, 85, 93], [(int)TypeIndex.Fire], [new MoveLvl("FlameWheel")], [(int)EggGroups.HumanLike], 1.3f, 44.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Gyarados", new PokemonInfo(0130, [95, 125, 79, 60, 100, 81], [(int)TypeIndex.Water,(int)TypeIndex.Flying], [new MoveLvl("WaterPulse"), new MoveLvl("IceFang"), new MoveLvl("Crunch", 24), new MoveLvl("Waterfall", 32), new MoveLvl("HydroPump", 40), new MoveLvl("DoubleEdge", 48), new MoveLvl("HyperBeam", 52)], [(int)EggGroups.Water2, (int)EggGroups.Dragon], 6.5f, 235.0f, (int)StageIndex.Stage1, (int)ExpTypes.Slow)},

            {"Lapras", new PokemonInfo(0131, [130, 85, 80, 85, 95, 60], [(int)TypeIndex.Water,(int)TypeIndex.Ice], [new MoveLvl("WaterGun"), new MoveLvl("Harden", 12), new MoveLvl("AquaRing", 20), new MoveLvl("ConfuseRay", 25), new MoveLvl("WaterPulse", 30), new MoveLvl("IceFang", 35), new MoveLvl("DoubleEdge", 40), new MoveLvl("WaterFall", 45), new MoveLvl("HydroPump", 50)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 2.5f, 220.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow)},
            ...
            {"Eevee", new PokemonInfo(0133, [55, 55, 50, 45, 65, 55], [(int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("QuickAttack", 10), new MoveLvl("Swift", 20), new MoveLvl("DoubleEdge", 50)], [(int)EggGroups.Field], 0.3f, 6.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Vaporeon", new PokemonInfo(0134, [130, 65, 60, 110, 95, 65], [(int)TypeIndex.Water], [new MoveLvl("WaterGun"), new MoveLvl("Tackle", 1), new MoveLvl("QuickAttack", 10), new MoveLvl("IceFang", 20), new MoveLvl("WaterPulse", 25), new MoveLvl("AquaRing", 30), new MoveLvl("Waterfall", 40), new MoveLvl("HydroPump", 50)], [(int)EggGroups.Field], 1.0f, 29.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            ...
            {"Flareon", new PokemonInfo(0136, [65, 130, 60, 95, 110, 65], [(int)TypeIndex.Fire], [new MoveLvl("Ember"), new MoveLvl("Tackle", 1), new MoveLvl("QuickAttack", 10), new MoveLvl("Smokescreen", 20), new MoveLvl("Crunch", 25), new MoveLvl("FlameWheel", 30), new MoveLvl("LavaPlume", 40), new MoveLvl("Overheat", 50)], [(int)EggGroups.Field], 0.9f, 25.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},

            {"Porygon", new PokemonInfo(0137, [65, 60, 70, 85, 75, 40], [(int)TypeIndex.Normal], [new MoveLvl("Discharge")], [(int)EggGroups.Mineral], 0.8f, 36.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},

            {"Omanyte", new PokemonInfo(0138, [35, 40, 100, 90, 55, 35], [(int)TypeIndex.Rock,(int)TypeIndex.Water], [new MoveLvl("WaterGun"), new MoveLvl("MudShot", 25), new MoveLvl("AncientPower", 30), new MoveLvl("HydroPump", 60)], [(int)EggGroups.Water1, (int)EggGroups.Water3], 0.4f, 7.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Omastar", new PokemonInfo(0139, [70, 60, 125, 115, 70, 55], [(int)TypeIndex.Rock,(int)TypeIndex.Water], [new MoveLvl("Crunch"), new MoveLvl("WaterGun", 1), new MoveLvl("MudShot", 25), new MoveLvl("AncientPower", 30), new MoveLvl("HydroPump", 70)], [(int)EggGroups.Water1, (int)EggGroups.Water3], 1.0f, 35.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},

            {"Kabuto", new PokemonInfo(0140, [30, 80, 90, 55, 45, 55], [(int)TypeIndex.Rock,(int)TypeIndex.Water], [new MoveLvl("Harden"), new MoveLvl("Tackle", 5), new MoveLvl("WaterGun", 15), new MoveLvl("MudShot", 25), new MoveLvl("AncientPower", 30), new MoveLvl("GigaDrain", 45), new MoveLvl("Waterfall", 50)], [(int)EggGroups.Water1, (int)EggGroups.Water3], 0.5f, 11.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Kabutops", new PokemonInfo(0141, [60, 115, 105, 65, 70, 80], [(int)TypeIndex.Rock,(int)TypeIndex.Water], [new MoveLvl("Harden", 1), new MoveLvl("Tackle", 5), new MoveLvl("WaterGun", 15), new MoveLvl("MudShot", 25), new MoveLvl("AncientPower", 30), new MoveLvl("GigaDrain", 49), new MoveLvl("Waterfall", 56)], [(int)EggGroups.Water1, (int)EggGroups.Water3], 1.3f, 40.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},

            {"Aerodactyl", new PokemonInfo(0142, [80, 105, 65, 60, 75, 130], [(int)TypeIndex.Rock,(int)TypeIndex.Flying], [new MoveLvl("AncientPower"), new MoveLvl("WingAttack", 10), new MoveLvl("Crunch", 30), new MoveLvl("HyperBeam", 55)], [(int)EggGroups.Flying], 1.8f, 59.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow)},
            {"Snorlax", new PokemonInfo(0143, [160, 110, 65, 65, 110, 30], [(int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("Crunch", 24), new MoveLvl("DoubleEdge", 44)], [(int)EggGroups.Monster], 2.1f, 460.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},

            {"Articuno", new PokemonInfo(0144, [90, 85, 100, 95, 125, 85], [(int)TypeIndex.Ice,(int)TypeIndex.Flying], [new MoveLvl("IceFang"), new MoveLvl("HydroPump")], [(int)EggGroups.NoEggs], 1.7f, 55.4f, (int)StageIndex.Basic, (int)ExpTypes.Slow, legendary: true, completed: false)},
            ...
            {"Typhlosion", new PokemonInfo(0157, [78, 84, 78, 109, 85, 100], [(int)TypeIndex.Fire], [new MoveLvl("Tackle", 1), new MoveLvl("Smokescreen", 6), new MoveLvl("Ember", 10), new MoveLvl("FlameWheel", 20), new MoveLvl("Swift", 31), new MoveLvl("LavaPlume", 43), new MoveLvl("Flamethrower", 48), new MoveLvl("Overheat", 56), new MoveLvl("DoubleEdge", 69), new MoveLvl("FireBlast", 74)], [(int)EggGroups.Field], 1.7f, 79.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            ...
            //Megas
            {"VenusaurMega", new PokemonInfo(0003, [80, 100, 123, 122, 120, 80], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [new MoveLvl("Earthquake")], [(int)EggGroups.NoEggs], 2.4f, 155.5f, (int)StageIndex.Mega, (int)ExpTypes.MediumSlow)},
            {"CharizardMegaX", new PokemonInfo(0006, [78, 130, 111, 130, 85, 100], [(int)TypeIndex.Fire,(int)TypeIndex.Dragon], [new MoveLvl("Crunch")], [(int)EggGroups.NoEggs], 1.7f, 110.5f, (int)StageIndex.Mega, (int)ExpTypes.MediumSlow)},
            ...
            {"GyaradosMega", new PokemonInfo(0130, [95, 155, 109, 70, 130, 81], [(int)TypeIndex.Water,(int)TypeIndex.Dark], [new MoveLvl("DragonBreath")], [(int)EggGroups.NoEggs], 6.5f, 305.0f, (int)StageIndex.Mega, (int)ExpTypes.Slow)},

            //Terrarian Regional Forms
            {"TerrarianOmanyte", new PokemonInfo(0138, [35, 40, 100, 90, 55, 35], [(int)TypeIndex.Water,(int)TypeIndex.Psychic], [new MoveLvl("ConfuseRay"), new MoveLvl("WaterPulse", 10), new MoveLvl("Psybeam", 20), new MoveLvl("AncientPower", 30), new MoveLvl("BubbleBeam", 45), new MoveLvl("Psychic", 50), new MoveLvl("HydroPump", 55)], [(int)EggGroups.Water1, (int)EggGroups.Water3], 0.4f, 7.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"TerrarianOmastar", new PokemonInfo(0139, [70, 60, 125, 115, 70, 55], [(int)TypeIndex.Water,(int)TypeIndex.Psychic], [new MoveLvl("IceFang"), new MoveLvl("ConfuseRay", 1), new MoveLvl("WaterPulse", 10), new MoveLvl("Psybeam", 20), new MoveLvl("AncientPower", 30), new MoveLvl("BubbleBeam", 50), new MoveLvl("Psychic", 60), new MoveLvl("HydroPump", 70)], [(int)EggGroups.Water1, (int)EggGroups.Water3], 1.0f, 35.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            {"TerrarianKabuto", new PokemonInfo(0140, [30, 70, 80, 65, 45, 65], [(int)TypeIndex.Rock,(int)TypeIndex.Ghost], [new MoveLvl("Harden"), new MoveLvl("Tackle", 5), new MoveLvl("ConfuseRay", 15), new MoveLvl("Slash", 25), new MoveLvl("AncientPower", 30), new MoveLvl("RockThrow", 42), new MoveLvl("FuryCutter", 47), new MoveLvl("ShadowBall", 52)], [(int)EggGroups.Amorphous], 0.5f, 1.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"TerrarianKabutops", new PokemonInfo(0141, [60, 95, 85, 85, 70, 100], [(int)TypeIndex.Rock,(int)TypeIndex.Ghost], [new MoveLvl("Hex"), new MoveLvl("Harden", 1), new MoveLvl("Tackle", 5), new MoveLvl("ConfuseRay", 15), new MoveLvl("Slash", 25), new MoveLvl("AncientPower", 30), new MoveLvl("RockThrow", 45), new MoveLvl("FuryCutter", 50), new MoveLvl("ShadowBall", 60)],  [(int)EggGroups.Amorphous], 1.3f, 4.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            {"TerrarianAerodactyl", new PokemonInfo(0142, [80, 90, 65, 95, 75, 110], [(int)TypeIndex.Dark,(int)TypeIndex.Flying], [new MoveLvl("WingAttack"), new MoveLvl("Gust"), new MoveLvl("AncientPower", 10), new MoveLvl("Crunch", 20), new MoveLvl("DragonBreath", 30), new MoveLvl("NightShade", 40), new MoveLvl("Flamethrower", 50), new MoveLvl("AirSlash", 60), new MoveLvl("HyperBeam", 70)], [(int)EggGroups.Flying], 1.8f, 59.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow)},
        };
    ...
    {
        Surface = 0, Underground = 1, Caverns = 2, Desert = 3, UndergroundDesert = 4, Snow = 5, UndergroundSnow = 6, TheCorruption = 7, UndergroundCorruption = 8, CorruptDesert = 9, CorruptUndergroundDesert = 10, CorruptIce = 11, TheCrimson = 12, UndergroundCrimson = 13, CrimsonDesert = 14, CrimsonUndergroundDesert = 15,
        CrimsonIce = 16, TheHallow = 17, UndergroundHallow = 18, HallowDesert = 19, HallowUndergroundDesert = 20, HallowIce = 21, Jungle = 22, UndergroundJungle = 23, SurfaceMushroom = 24, UndergroundMushroom = 25, Sky = 26, Beach = 27, Ocean = 28, Marble = 29, Granite = 30, TheTemple = 31,
        TheDungeon = 32, TheUnderworld = 33, SpiderNest = 34, Graveyard = 35,
        Meteor = 44,
        SolarPillar = 56,
        VortexPillar = 57,
        NebulaPillar = 58,
