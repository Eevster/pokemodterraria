...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Magnemite", new PokemonInfo(0081, [25, 35, 70, 95, 55, 45], [(int)TypeIndex.Electric,(int)TypeIndex.Steel], [new MoveLvl("Tackle"), new MoveLvl("Supersonic", 4), new MoveLvl("ThunderWave", 8), new MoveLvl("ElectroBall", 12), new MoveLvl("SonicBoom", 15), new MoveLvl("Swift", 20), new MoveLvl("Screech", 24), new MoveLvl("FlashCannon", 28), new MoveLvl("Discharge", 36), new MoveLvl("Thunder", 44)], [(int)EggGroups.Mineral], 0.3f, 6.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            {"Magneton", new PokemonInfo(0082, [50, 60, 95, 120, 70, 70], [(int)TypeIndex.Electric,(int)TypeIndex.Steel], [new MoveLvl("Thunderbolt"), new MoveLvl("Tackle", 1), new MoveLvl("Supersonic", 1), new MoveLvl("ThunderWave", 1), new MoveLvl("ElectroBall", 12), new MoveLvl("SonicBoom", 15), new MoveLvl("Swift", 20), new MoveLvl("Screech", 24), new MoveLvl("FlashCannon", 28), new MoveLvl("Discharge", 40), new MoveLvl("Thunder", 52)], [(int)EggGroups.Mineral], 1.0f, 60.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            {"Voltorb", new PokemonInfo(0100, [40, 30, 50, 55, 55, 100], [(int)TypeIndex.Electric], [new MoveLvl("Tackle"), new MoveLvl("ThunderWave", 4), new MoveLvl("SonicBoom", 6), new MoveLvl("RockThrow", 11), new MoveLvl("Screech", 13), new MoveLvl("Swift", 16), new MoveLvl("ElectroBall", 22), new MoveLvl("SelfDestruct", 28), new MoveLvl("Thunderbolt", 32), new MoveLvl("Discharge", 37), new MoveLvl("Explosion", 41)], [(int)EggGroups.Mineral], 0.5f, 10.4f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            {"Electrode", new PokemonInfo(0101, [60, 50, 70, 80, 80, 150], [(int)TypeIndex.Electric], [new MoveLvl("Tackle", 1), new MoveLvl("ThunderWave", 4), new MoveLvl("SonicBoom", 6), new MoveLvl("RockThrow", 11), new MoveLvl("Screech", 13), new MoveLvl("Swift", 16), new MoveLvl("ElectroBall", 22), new MoveLvl("SelfDestruct", 28), new MoveLvl("Thunderbolt", 34), new MoveLvl("Discharge", 41), new MoveLvl("Explosion", 47)], [(int)EggGroups.Mineral], 1.2f, 66.6f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            {"Electabuzz", new PokemonInfo(0125, [65, 83, 57, 95, 85, 105], [(int)TypeIndex.Electric], [new MoveLvl("Thunder"), new MoveLvl("ShockWave", 16), new MoveLvl("Screech", 24)], [(int)EggGroups.HumanLike], 1.1f, 30.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Feraligatr", new PokemonInfo(0160, [85, 105, 100, 79, 83, 78], [(int)TypeIndex.Water], [new MoveLvl("Tackle", 1), new MoveLvl("WaterGun", 6), new MoveLvl("MudShot", 13), new MoveLvl("IceFang", 21), new MoveLvl("Crunch", 32), new MoveLvl("Screech", 44), new MoveLvl("Slash", 45), new MoveLvl("Waterfall", 58), new MoveLvl("AquaTail", 59), new MoveLvl("FocusPunch", 71), new MoveLvl("HydroPump", 76)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 2.3f, 88.8f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},
            ...
            {"Umbreon", new PokemonInfo(0197, [95, 65, 110, 60, 130, 65], [(int)TypeIndex.Dark], [new MoveLvl("Crunch"), new MoveLvl("Tackle", 1), new MoveLvl("Bite", 1), new MoveLvl("Swift", 1), new MoveLvl("QuickAttack", 10), new MoveLvl("ConfuseRay", 20), new MoveLvl("Toxic", 25), new MoveLvl("Screech", 45)], [(int)EggGroups.Field], 1.0f, 29.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            //Gen 4
            {"Cranidos", new PokemonInfo(0408, [67, 125, 40, 30, 30, 58], [(int)TypeIndex.Rock], [new MoveLvl("Tackle"), new MoveLvl("Harden", 8), new MoveLvl("Bite", 16), new MoveLvl("Slam", 22), new MoveLvl("AncientPower", 28), new MoveLvl("PsychoCut", 35), new MoveLvl("DoubleEdge", 40), new MoveLvl("Screech", 42), new MoveLvl("StoneEdge", 45)], [(int)EggGroups.Monster], 0.9f, 31.5f, (int)StageIndex.Basic, (int)ExpTypes.Erratic, artist: "Digibeast")},
            {"Rampardos", new PokemonInfo(0409, [97, 165, 60, 65, 50, 58], [(int)TypeIndex.Rock], [new MoveLvl("Crunch"), new MoveLvl("Tackle", 1), new MoveLvl("Harden", 8), new MoveLvl("Bite", 16), new MoveLvl("Slam", 22), new MoveLvl("AncientPower", 28), new MoveLvl("PsychoCut", 38), new MoveLvl("DoubleEdge", 46), new MoveLvl("Screech", 51), new MoveLvl("StoneEdge", 54)], [(int)EggGroups.Monster], 1.6f, 102.5f, (int)StageIndex.Stage1, (int)ExpTypes.Erratic, artist: "Digibeast")},
            ...
            //Gen 5
            {"Joltik", new PokemonInfo(0595, [50, 47, 50, 57, 50, 65], [(int)TypeIndex.Bug,(int)TypeIndex.Electric], [new MoveLvl("FuryCutter"), new MoveLvl("StringShot", 8), new MoveLvl("ThunderWave", 16), new MoveLvl("ElectroBall", 20), new MoveLvl("Crunch", 26), new MoveLvl("Slash", 32), new MoveLvl("Discharge", 37), new MoveLvl("Screech", 40), new MoveLvl("PinMissile", 44)], [(int)EggGroups.Bug], 0.1f, 0.6f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            {"Galvantula", new PokemonInfo(0596, [70, 77, 60, 97, 60, 108], [(int)TypeIndex.Bug,(int)TypeIndex.Electric], [new MoveLvl("FuryCutter", 1), new MoveLvl("StringShot", 8), new MoveLvl("ThunderWave", 16), new MoveLvl("ElectroBall", 20), new MoveLvl("Crunch", 26), new MoveLvl("Slash", 32), new MoveLvl("Discharge", 39), new MoveLvl("Screech", 44), new MoveLvl("PinMissile", 50)], [(int)EggGroups.Bug], 0.8f, 14.3f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
        ...
        public static Dictionary<string, PokemonAttackInfo> pokemonAttacks = new(){
            ...
            {"Supersonic", new PokemonAttackInfo(0,40,60,800f,false,false,(int)TypeIndex.Normal, true)},
