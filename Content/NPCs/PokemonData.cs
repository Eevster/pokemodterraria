...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"HisuianVoltorb", new PokemonInfo(0100, [40, 30, 50, 55, 55, 100], [(int)TypeIndex.Electric,(int)TypeIndex.Grass], [new MoveLvl("Tackle", 1), new MoveLvl("ThunderWave", 4), new MoveLvl("BulletSeed", 9), new MoveLvl("RockThrow", 11), new MoveLvl("Screech", 13), new MoveLvl("Swift", 16), new MoveLvl("ElectroBall", 22), new MoveLvl("SelfDestruct", 26), new MoveLvl("EnergyBall", 29), new MoveLvl("SeedBomb", 34), new MoveLvl("Discharge", 34), new MoveLvl("Explosion", 41), new MoveLvl("RapidSpin", 46), new MoveLvl("LeafStorm", 50)], [(int)EggGroups.Mineral], 0.5f, 13.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            {"HisuianElectrode", new PokemonInfo(0101, [60, 50, 70, 80, 80, 150], [(int)TypeIndex.Electric,(int)TypeIndex.Grass], [new MoveLvl("SolarBeam"), new MoveLvl("Tackle", 1), new MoveLvl("ThunderWave", 4), new MoveLvl("BulletSeed", 9), new MoveLvl("RockThrow", 11), new MoveLvl("Screech", 13), new MoveLvl("Swift", 16), new MoveLvl("ElectroBall", 22), new MoveLvl("SelfDestruct", 26), new MoveLvl("EnergyBall", 29), new MoveLvl("SeedBomb", 34), new MoveLvl("Discharge", 34), new MoveLvl("Explosion", 41), new MoveLvl("RapidSpin", 46), new MoveLvl("LeafStorm", 50)], [(int)EggGroups.Mineral], 1.2f, 71.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
