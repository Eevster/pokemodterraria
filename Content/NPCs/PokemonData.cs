...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Raichu", new PokemonInfo(0026, [60, 90, 55, 90, 80, 110], [(int)TypeIndex.Electric], [new MoveLvl("ThunderPunch"), new MoveLvl("Agility", 1), new MoveLvl("QuickAttack", 1), new MoveLvl("DoubleTeam", 1), new MoveLvl("ElectroBall", 1), new MoveLvl("Discharge", 1), new MoveLvl("Thunderbolt", 5)], [(int)EggGroups.Field, (int)EggGroups.Fairy], 0.8f, 30.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            {"Electabuzz", new PokemonInfo(0125, [65, 83, 57, 95, 85, 105], [(int)TypeIndex.Electric], [new MoveLvl("Thunder"), new MoveLvl("ShockWave", 16), new MoveLvl("Screech", 24), new MoveLvl("ThunderPunch", 28)], [(int)EggGroups.HumanLike], 1.1f, 30.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            //Gen 5
            {"Venipede", new PokemonInfo(0543, [30, 45, 59, 30, 39, 57], [(int)TypeIndex.Bug,(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("Screech", 16), new MoveLvl("PinMissile", 20), new MoveLvl("TakeDown", 24), new MoveLvl("Toxic", 36), new MoveLvl("DoubleEdge", 52)], [(int)EggGroups.Bug], 0.4f, 5.3f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, artist: "Kerpi")},
            {"Whirlipede", new PokemonInfo(0544, [40, 55, 99, 40, 79, 47], [(int)TypeIndex.Bug,(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("Screech", 16), new MoveLvl("PinMissile", 20), new MoveLvl("TakeDown", 24), new MoveLvl("Toxic", 36), new MoveLvl("DoubleEdge", 52)], [(int)EggGroups.Bug], 1.2f, 58.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, artist: "Kerpi")},
            {"Scolipede", new PokemonInfo(0545, [60, 100, 89, 55, 69, 112], [(int)TypeIndex.Bug,(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("Screech", 16), new MoveLvl("PinMissile", 20), new MoveLvl("TakeDown", 24), new MoveLvl("Toxic", 36), new MoveLvl("DoubleEdge", 52)], [(int)EggGroups.Bug], 2.5f, 200.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "Kerpi")},
            ...
            {"HisuianVoltorb", new PokemonInfo(0100, [40, 30, 50, 55, 55, 100], [(int)TypeIndex.Electric,(int)TypeIndex.Grass], [new MoveLvl("Tackle", 1), new MoveLvl("ThunderWave", 4), new MoveLvl("BulletSeed", 9), new MoveLvl("RockThrow", 11), new MoveLvl("Screech", 13), new MoveLvl("Swift", 16), new MoveLvl("ElectroBall", 22), new MoveLvl("SelfDestruct", 26), new MoveLvl("EnergyBall", 29), new MoveLvl("GigaDrain", 34), new MoveLvl("Discharge", 34), new MoveLvl("Explosion", 41), new MoveLvl("RapidSpin", 46), new MoveLvl("LeafStorm", 50)], [(int)EggGroups.Mineral], 0.5f, 13.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            {"HisuianElectrode", new PokemonInfo(0101, [60, 50, 70, 80, 80, 150], [(int)TypeIndex.Electric,(int)TypeIndex.Grass], [new MoveLvl("SolarBeam"), new MoveLvl("Tackle", 1), new MoveLvl("ThunderWave", 4), new MoveLvl("BulletSeed", 9), new MoveLvl("RockThrow", 11), new MoveLvl("Screech", 13), new MoveLvl("Swift", 16), new MoveLvl("ElectroBall", 22), new MoveLvl("SelfDestruct", 26), new MoveLvl("EnergyBall", 29), new MoveLvl("GigaDrain", 34), new MoveLvl("Discharge", 34), new MoveLvl("Explosion", 41), new MoveLvl("RapidSpin", 46), new MoveLvl("LeafStorm", 50)], [(int)EggGroups.Mineral], 1.2f, 71.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
