...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Tentacool", new PokemonInfo(0072, [40, 40, 35, 50, 100, 70], [(int)TypeIndex.Water,(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("WaterGun"), new MoveLvl("Acid", 4), new MoveLvl("ConfuseRay", 8), new MoveLvl("WaterPulse", 16), new MoveLvl("BubbleBeam", 24), new MoveLvl("AcidArmor", 32), new MoveLvl("SludgeBomb", 40), new MoveLvl("HydroPump", 48)], [(int)EggGroups.Water3], 0.9f, 45.5f, (int)StageIndex.Basic, (int)ExpTypes.Slow, artist: "gotilies")},
            {"Tentacruel", new PokemonInfo(0073, [80, 70, 65, 80, 120, 100], [(int)TypeIndex.Water,(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("WaterGun"), new MoveLvl("ConfuseRay", 8), new MoveLvl("WaterPulse", 16), new MoveLvl("BubbleBeam", 24), new MoveLvl("AcidArmor", 34), new MoveLvl("SludgeBomb", 46), new MoveLvl("HydroPump", 58)], [(int)EggGroups.Water3], 1.6f, 55.0f, (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false, artist: "gotilies")},
            ...
            {"Slowpoke", new PokemonInfo(0079, [90, 65, 65, 40, 40, 15], [(int)TypeIndex.Water,(int)TypeIndex.Psychic], [new MoveLvl("Confusion"), new MoveLvl("Amnesia", 27)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 1.2f, 36.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false, artist: "Kerpi")},
            ...
            {"Vaporeon", new PokemonInfo(0134, [130, 65, 60, 110, 95, 65], [(int)TypeIndex.Water], [new MoveLvl("WaterGun"), new MoveLvl("Tackle", 1), new MoveLvl("Bite", 1), new MoveLvl("QuickAttack", 10), new MoveLvl("IceFang", 20), new MoveLvl("WaterPulse", 25), new MoveLvl("AquaRing", 30), new MoveLvl("Waterfall", 40), new MoveLvl("AcidArmor", 45), new MoveLvl("HydroPump", 50)], [(int)EggGroups.Field], 1.0f, 29.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
