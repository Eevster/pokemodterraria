...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData{
        ...
        public static Dictionary<string, PokemonAttackInfo> pokemonAttacks = new(){
            ...
            {"Dig", new PokemonAttackInfo(80,90,30,800f,false,true,(int)TypeIndex.Ground)},
            ...
            {"Earthquake", new PokemonAttackInfo(100,32,60,800f,false,true,(int)TypeIndex.Ground)},
