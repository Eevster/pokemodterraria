...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"TerrarianSolosis", new PokemonInfo(0577, [45, 30, 40, 105, 50, 20], [(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("PinMissile", 15), new MoveLvl("Toxic", 18)], [(int)EggGroups.Bug], 0.4f, 5.3f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, artist: "Kerpi")},
            {"TerrarianDuosion", new PokemonInfo(0578, [65, 40, 50, 125, 60, 30], [(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("PinMissile", 15), new MoveLvl("Toxic", 18), new MoveLvl("Acid", 35)], [(int)EggGroups.Bug], 1.2f, 58.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, artist: "Kerpi")},
            {"TerrarianReuniclus", new PokemonInfo(0579, [110, 65, 75, 125, 85, 30], [(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("PinMissile", 15), new MoveLvl("Toxic", 18), new MoveLvl("Acid", 35), new MoveLvl("SludgeBomb", 50)], [(int)EggGroups.Bug], 2.5f, 200.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "Kerpi")},
        };
