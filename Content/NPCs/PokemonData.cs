...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"AlolanRattata", new PokemonInfo(0019, [30, 56, 35, 25, 35, 72], [(int)TypeIndex.Dark, (int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("Bite", 4), new MoveLvl("QuickAttack", 10), new MoveLvl("HyperFang", 16), new MoveLvl("Crunch", 22), new MoveLvl("DoubleEdge", 31)], [(int)EggGroups.Field], 0.3f, 3.8f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
