...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"NidoranF", new PokemonInfo(0029, [46, 57, 40, 40, 40, 50], [(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("Tackle", 16), new MoveLvl("DoubleKick", 25), new MoveLvl("Bite", 30), new MoveLvl("Toxic", 40), new MoveLvl("Crunch", 50), new MoveLvl("Earthquake", 55)], [(int)EggGroups.Monster, (int)EggGroups.Field], 0.4f, 7.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Nidorina", new PokemonInfo(0030, [70, 62, 67, 55, 55, 56], [(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("Tackle", 16), new MoveLvl("DoubleKick", 29), new MoveLvl("Bite", 36), new MoveLvl("Toxic", 50), new MoveLvl("Crunch", 64), new MoveLvl("Earthquake", 71)], [(int)EggGroups.NoEggs], 0.8f, 20.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            ...
            {"Jigglypuff", new PokemonInfo(0039, [115, 45, 20, 45, 25, 20], [(int)TypeIndex.Normal,(int)TypeIndex.Fairy], [new MoveLvl("Tackle"), new MoveLvl("Slam", 24)], [(int)EggGroups.Fairy], 0.5f, 5.5f, (int)StageIndex.Basic, (int)ExpTypes.Fast, completed: false)},
            {"Wigglytuff", new PokemonInfo(0040, [140, 70, 45, 85, 50, 45], [(int)TypeIndex.Normal,(int)TypeIndex.Fairy], [new MoveLvl("DoubleEdge"), new MoveLvl("Swift"), new MoveLvl("Slam", 1)], [(int)EggGroups.Fairy], 1.0f, 12.0f, (int)StageIndex.Stage1, (int)ExpTypes.Fast, completed: false)},
            ...
            {"Krabby", new PokemonInfo(0098, [30, 105, 90, 25, 25, 50], [(int)TypeIndex.Water], [new MoveLvl("Bubble"), new MoveLvl("Slam", 36)], [(int)EggGroups.Water3], 0.4f, 6.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Kingler", new PokemonInfo(0099, [55, 130, 115, 50, 50, 75], [(int)TypeIndex.Water], [new MoveLvl("WaterPulse"), new MoveLvl("Slam", 42)], [(int)EggGroups.Water3], 1.3f, 60.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
