...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Wartortle", new PokemonInfo(0008, [59, 63, 80, 65, 80, 58], [(int)TypeIndex.Water], [new MoveLvl("Tackle", 1), new MoveLvl("WaterGun", 1), new MoveLvl("WaterPulse", 12), new MoveLvl("Bite", 15), new MoveLvl("Harden", 20), new MoveLvl("BubbleBeam", 30), new MoveLvl("Waterfall", 40), new MoveLvl("HydroPump", 45), new MoveLvl("DoubleEdge", 50)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 1.0f, 22.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Blastoise", new PokemonInfo(0009, [79, 83, 100, 85, 105, 78], [(int)TypeIndex.Water], [new MoveLvl("FlashCannon"), new MoveLvl("Tackle", 1), new MoveLvl("WaterGun", 1), new MoveLvl("WaterPulse", 12), new MoveLvl("Bite", 15), new MoveLvl("Harden", 20), new MoveLvl("BubbleBeam", 30), new MoveLvl("Waterfall", 42), new MoveLvl("HydroPump", 49), new MoveLvl("DoubleEdge", 56)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 1.6f, 85.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
        ...
        public static Dictionary<string, PokemonAttackInfo> pokemonAttacks = new(){
            ...
            {"ElectroBall", new PokemonAttackInfo(40,30,50,800f,false,false,(int)TypeIndex.Electric)},
