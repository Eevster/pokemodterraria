...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Porygon", new PokemonInfo(0137, [65, 60, 70, 85, 75, 40], [(int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("ThunderWave", 8), new MoveLvl("ElectroBall", 16), new MoveLvl("Psybeam", 24), new MoveLvl("HealPulse", 32), new MoveLvl("Discharge",40), new MoveLvl("Slam", 48), new MoveLvl("Thunder", 56)], [(int)EggGroups.Mineral], 0.8f, 36.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
