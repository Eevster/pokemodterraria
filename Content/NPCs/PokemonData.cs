...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData{
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Alakazam", new PokemonInfo([55, 50, 45, 135, 95, 120], [(int)TypeIndex.Psychic], ["PsychoCut","Psybeam"], (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            ...
            {"Geodude", new PokemonInfo([40, 80, 100, 30, 30, 20], [(int)TypeIndex.Rock,(int)TypeIndex.Ground], ["SelfDestruct"], (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            ...
            {"Gyarados", new PokemonInfo([95, 125, 79, 60, 100, 81], [(int)TypeIndex.Water,(int)TypeIndex.Flying], ["HydroPump"], (int)StageIndex.Stage1, (int)ExpTypes.Slow)},
        ...
        public static Dictionary<string, PokemonAttackInfo> pokemonAttacks = new(){
            ...
            {"NightShade", new PokemonAttackInfo(90,40,60,800f,true,true,(int)TypeIndex.Ghost, true)},
            ...
            {"Psychic", new PokemonAttackInfo(90,45,60,800f,true,true,(int)TypeIndex.Psychic, true)},
