...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Venusaur", new PokemonInfo(0003, [80, 82, 83, 100, 100, 80], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [new MoveLvl("LeafStorm"), new MoveLvl("Tackle", 1), new MoveLvl("VineWhip", 1), new MoveLvl("LeechSeed", 9), new MoveLvl("RazorLeaf", 12), new MoveLvl("PoisonPowder", 15), new MoveLvl("BulletSeed", 20), new MoveLvl("GigaDrain", 37), new MoveLvl("DoubleEdge", 51), new MoveLvl("SolarBeam", 58)], [(int)EggGroups.Monster, (int)EggGroups.Grass], 2.0f, 100.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},
            ...
            {"Pidgey", new PokemonInfo(0016, [40, 45, 40, 35, 35, 56], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("Tackle"), new MoveLvl("Gust", 9), new MoveLvl("QuickAttack", 13), new MoveLvl("WingAttack", 33), new MoveLvl("AirSlash", 49)], [(int)EggGroups.Flying], 0.3f, 1.8f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},
            {"Pidgeotto", new PokemonInfo(0017, [63, 60, 55, 50, 50, 71], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("QuickAttack", 13), new MoveLvl("WingAttack", 37), new MoveLvl("AirSlash", 57)], [(int)EggGroups.Flying], 1.1f, 30.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},
            {"Pidgeot", new PokemonInfo(0018, [83, 80, 75, 70, 70, 101], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("WingAttack", 38), new MoveLvl("AirSlash", 62)], [(int)EggGroups.Flying], 1.5f, 39.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},

            {"Rattata", new PokemonInfo(0019, [30, 56, 35, 25, 35, 72], [(int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("QuickAttack", 4), new MoveLvl("Bite", 22), new MoveLvl("HyperFang", 28), new MoveLvl("DoubleEdge", 31)], [(int)EggGroups.Field], 0.3f, 3.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            {"Raticate", new PokemonInfo(0020, [55, 81, 60, 50, 70, 97], [(int)TypeIndex.Normal], [new MoveLvl("Tackle", 1), new MoveLvl("QuickAttack", 4), new MoveLvl("Bite", 24), new MoveLvl("HyperFang", 34), new MoveLvl("DoubleEdge", 39)], [(int)EggGroups.Field], 0.7f, 18.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            {"Raichu", new PokemonInfo(0026, [60, 90, 55, 90, 80, 110], [(int)TypeIndex.Electric], [new MoveLvl("Thunderbolt"), new MoveLvl("QuickAttack", 1), new MoveLvl("ElectroBall", 1), new MoveLvl("Discharge", 1)], [(int)EggGroups.Field, (int)EggGroups.Fairy], 0.8f, 30.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            {"Poliwrath", new PokemonInfo(0062, [90, 95, 95, 70, 90, 70], [(int)TypeIndex.Water,(int)TypeIndex.Fighting], [new MoveLvl("BrickBreak"), new MoveLvl("Mudshot", 1), new MoveLvl("BubbleBeam", 1), new MoveLvl("Slam", 1)], [(int)EggGroups.Water1], 1.3f, 54.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},
            ...
            {"Bellsprout", new PokemonInfo(0069, [50, 75, 35, 70, 30, 40], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [new MoveLvl("VineWhip"), new MoveLvl("PoisonPowder", 12), new MoveLvl("ThunderWave", 17), new MoveLvl("PoisonSting", 23), new MoveLvl("Crunch", 29), new MoveLvl("RazorLeaf", 39), new MoveLvl("SludgeBomb", 41), new MoveLvl("Slam", 47)], [(int)EggGroups.Grass], 0.7f, 4.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},
            ...
            {"Victreebel", new PokemonInfo(0071, [80, 105, 65, 100, 70, 70], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [new MoveLvl("BulletSeed"), new MoveLvl("PoisonSting", 1), new MoveLvl("RazorLeaf", 1), new MoveLvl("Slam", 1), new MoveLvl("LeafStorm", 32), new MoveLvl("LeafBlade", 44)], [(int)EggGroups.Grass], 1.7f, 15.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},
            ...
            {"Gastly", new PokemonInfo(0092, [30, 35, 30, 100, 35, 80], [(int)TypeIndex.Ghost,(int)TypeIndex.Poison], [new MoveLvl("ConfuseRay"), new MoveLvl("Confusion", 12), new MoveLvl("Hex", 20), new MoveLvl("NightShade", 28), new MoveLvl("Crunch", 34), new MoveLvl("ShadowBall", 40)], [(int)EggGroups.Amorphous], 1.3f, 0.1f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},
            ...
            {"Voltorb", new PokemonInfo(0100, [40, 30, 50, 55, 55, 100], [(int)TypeIndex.Electric], [new MoveLvl("Tackle"), new MoveLvl("ThunderWave", 4), new MoveLvl("RockThrow", 11), new MoveLvl("Swift", 16), new MoveLvl("ElectroBall", 22), new MoveLvl("SelfDestruct", 28), new MoveLvl("Thunderbolt", 32), new MoveLvl("Discharge", 37), new MoveLvl("Explosion", 41)], [(int)EggGroups.Mineral], 0.5f, 10.4f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            {"Chansey", new PokemonInfo(0113, [250, 5, 5, 35, 105, 50], [(int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("Swift"), new MoveLvl("Harden", 8), new MoveLvl("DoubleKick", 16), new MoveLvl("Slash", 24), new MoveLvl("HealPulse", 32), new MoveLvl("DoubleEdge", 40)], [(int)EggGroups.Fairy], 1.1f, 34.6f, (int)StageIndex.Basic, (int)ExpTypes.Fast, artist: "JACSMITH")},
            ...
            {"Eevee", new PokemonInfo(0133, [55, 55, 50, 45, 65, 55], [(int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("QuickAttack", 10), new MoveLvl("Swift", 20), new MoveLvl("Bite", 25), new MoveLvl("DoubleEdge", 50)], [(int)EggGroups.Field], 0.3f, 6.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            {"Meganium", new PokemonInfo(0154, [80, 82, 100, 83, 100, 80], [(int)TypeIndex.Grass], [new MoveLvl("LeafStorm"), new MoveLvl("Tackle", 1), new MoveLvl("RazorLeaf", 6), new MoveLvl("PoisonPowder", 9), new MoveLvl("AquaRing", 18), new MoveLvl("MagicalLeaf", 22), new MoveLvl("LeechSeed", 26), new MoveLvl("Slam", 40), new MoveLvl("HealPulse", 54), new MoveLvl("SolarBeam", 66), new MoveLvl("LeafBlade", 70)], [(int)EggGroups.Monster, (int)EggGroups.Grass], 1.8f, 100.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},

            {"Cyndaquil", new PokemonInfo(0155, [39, 52, 43, 60, 50, 65], [(int)TypeIndex.Fire], [new MoveLvl("Tackle"), new MoveLvl("Smokescreen", 6), new MoveLvl("Ember", 10), new MoveLvl("FlameWheel", 19), new MoveLvl("Swift", 28), new MoveLvl("LavaPlume", 37), new MoveLvl("Flamethrower", 40), new MoveLvl("Overheat", 46), new MoveLvl("DoubleEdge", 55)], [(int)EggGroups.Field], 0.5f, 7.9f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},
            ...
            {"Typhlosion", new PokemonInfo(0157, [78, 84, 78, 109, 85, 100], [(int)TypeIndex.Fire], [new MoveLvl("Tackle", 1), new MoveLvl("Smokescreen", 6), new MoveLvl("Ember", 10), new MoveLvl("FlameWheel", 20), new MoveLvl("Swift", 31), new MoveLvl("LavaPlume", 43), new MoveLvl("Flamethrower", 48), new MoveLvl("Overheat", 56), new MoveLvl("DoubleEdge", 69), new MoveLvl("FireBlast", 74)], [(int)EggGroups.Field], 1.7f, 79.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},

            {"Totodile", new PokemonInfo(0158, [50, 65, 64, 44, 48, 43], [(int)TypeIndex.Water], [new MoveLvl("Tackle"), new MoveLvl("WaterGun", 6), new MoveLvl("MudShot", 13), new MoveLvl("IceFang", 20), new MoveLvl("Crunch", 27), new MoveLvl("Slash", 34), new MoveLvl("AquaTail", 41), new MoveLvl("Waterfall", 43), new MoveLvl("FocusPunch", 48), new MoveLvl("HydroPump", 50)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 0.6f, 9.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},
