...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Machop", new PokemonInfo(0066, [70, 80, 50, 35, 35, 35], [(int)TypeIndex.Fighting], [new MoveLvl("Tackle")], [(int)EggGroups.HumanLike], 0.8f, 19.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, completed: false)},
            {"Machoke", new PokemonInfo(0067, [80, 100, 70, 50, 60, 45], [(int)TypeIndex.Fighting], [new MoveLvl("DoubleKick")], [(int)EggGroups.HumanLike], 1.5f, 70.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, completed: false)},
            {"Machamp", new PokemonInfo(0068, [90, 130, 80, 65, 85, 55], [(int)TypeIndex.Fighting], [new MoveLvl("FocusPunch")], [(int)EggGroups.HumanLike], 1.6f, 130.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, completed: false)},
            ...
            {"Shellder", new PokemonInfo(0090, [30, 65, 100, 45, 25, 40], [(int)TypeIndex.Water], [new MoveLvl("Bubble")], [(int)EggGroups.Water3], 0.3f, 4.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Cloyster", new PokemonInfo(0091, [50, 95, 180, 85, 45, 70], [(int)TypeIndex.Water,(int)TypeIndex.Ice], [new MoveLvl("HydroPump"), new MoveLvl("IceFang")], [(int)EggGroups.Water3], 1.5f, 132.5f, (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},
            ...
            {"Onix", new PokemonInfo(0095, [35, 45, 160, 30, 45, 70], [(int)TypeIndex.Rock,(int)TypeIndex.Ground], [new MoveLvl("RockThrow"), new MoveLvl("Earthquake")], [(int)EggGroups.Mineral], 8.8f, 210.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Exeggcute", new PokemonInfo(0102, [60, 40, 80, 60, 45, 40], [(int)TypeIndex.Grass,(int)TypeIndex.Psychic], [new MoveLvl("Confusion")], [(int)EggGroups.Grass], 0.4f, 2.5f, (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Exeggutor", new PokemonInfo(0103, [95, 95, 85, 125, 75, 55], [(int)TypeIndex.Grass,(int)TypeIndex.Psychic], [new MoveLvl("GigaDrain")], [(int)EggGroups.Grass], 2.0f, 120.0f, (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},

            {"Cubone", new PokemonInfo(0104, [50, 50, 95, 40, 50, 35], [(int)TypeIndex.Ground], [new MoveLvl("Tackle")], [(int)EggGroups.Monster], 0.4f, 6.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Marowak", new PokemonInfo(0105, [60, 80, 110, 50, 80, 45], [(int)TypeIndex.Ground], [new MoveLvl("Earthquake")], [(int)EggGroups.Monster], 1.0f, 45.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Tangela", new PokemonInfo(0114, [65, 55, 115, 100, 40, 60], [(int)TypeIndex.Grass], [new MoveLvl("MagicalLeaf")], [(int)EggGroups.Grass], 1.0f, 35.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"MrMime", new PokemonInfo(0122, [40, 45, 65, 100, 120, 90], [(int)TypeIndex.Psychic,(int)TypeIndex.Fairy], [new MoveLvl("Confusion")], [(int)EggGroups.HumanLike], 1.3f, 54.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Lapras", new PokemonInfo(0131, [130, 85, 80, 85, 95, 60], [(int)TypeIndex.Water,(int)TypeIndex.Ice], [new MoveLvl("IceFang")], [(int)EggGroups.Monster, (int)EggGroups.Water1], 2.5f, 220.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
