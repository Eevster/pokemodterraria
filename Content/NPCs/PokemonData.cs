...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Ivysaur", new PokemonInfo(0002, [60, 62, 63, 80, 80, 60], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [new MoveLvl("Tackle", 1), new MoveLvl("VineWhip", 3), new MoveLvl("LeechSeed", 9), new MoveLvl("RazorLeaf", 12), new MoveLvl("PoisonPowder", 15), new MoveLvl("BulletSeed", 20), new MoveLvl("TakeDown", 25), new MoveLvl("GigaDrain", 35), new MoveLvl("DoubleEdge", 45), new MoveLvl("SolarBeam", 50)], [(int)EggGroups.Monster, (int)EggGroups.Grass], 1.0f, 13.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},
            {"Venusaur", new PokemonInfo(0003, [80, 82, 83, 100, 100, 80], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [new MoveLvl("LeafStorm"), new MoveLvl("Tackle", 1), new MoveLvl("VineWhip", 1), new MoveLvl("LeechSeed", 9), new MoveLvl("RazorLeaf", 12), new MoveLvl("PoisonPowder", 15), new MoveLvl("BulletSeed", 20), new MoveLvl("TakeDown", 25), new MoveLvl("GigaDrain", 37), new MoveLvl("DoubleEdge", 51), new MoveLvl("SolarBeam", 58)], [(int)EggGroups.Monster, (int)EggGroups.Grass], 2.0f, 100.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "JACSMITH")},
            ...
            {"Vaporeon", new PokemonInfo(0134, [130, 65, 60, 110, 95, 65], [(int)TypeIndex.Water], [new MoveLvl("WaterGun"), new MoveLvl("Tackle", 1), new MoveLvl("Bite", 1), new MoveLvl("TakeDown", 1), new MoveLvl("QuickAttack", 10), new MoveLvl("IceFang", 20), new MoveLvl("WaterPulse", 25), new MoveLvl("AuroraBeam", 30), new MoveLvl("AquaRing", 35), new MoveLvl("Waterfall", 40), new MoveLvl("AcidArmor", 45), new MoveLvl("HydroPump", 50)], [(int)EggGroups.Field], 1.0f, 29.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            {"Jolteon", new PokemonInfo(0135, [65, 65, 60, 110, 95, 130], [(int)TypeIndex.Electric], [new MoveLvl("ThunderWave"), new MoveLvl("Tackle", 1), new MoveLvl("Bite", 1), new MoveLvl("TakeDown", 1), new MoveLvl("QuickAttack", 10), new MoveLvl("DoubleKick", 20), new MoveLvl("Thunderbolt", 25), new MoveLvl("PinMissile", 30), new MoveLvl("Discharge", 40), new MoveLvl("Agility", 45), new MoveLvl("Thunder", 50)], [(int)EggGroups.Field], 0.8f, 24.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
