...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData{
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Spearow", new PokemonInfo([40, 60, 30, 31, 31, 70], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Fearow", new PokemonInfo([65, 90, 65, 61, 61, 100], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Ekans", new PokemonInfo([35, 60, 44, 40, 54, 55], [(int)TypeIndex.Poison], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Arbok", new PokemonInfo([60, 95, 69, 65, 79, 80], [(int)TypeIndex.Poison], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Sandshrew", new PokemonInfo([50, 75, 85, 20, 30, 40], [(int)TypeIndex.Ground], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Sandslash", new PokemonInfo([75, 100, 110, 45, 55, 65], [(int)TypeIndex.Ground], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"NidoranM", new PokemonInfo([55, 47, 52, 40, 40, 41], [(int)TypeIndex.Poison], ["DoubleKick"], (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Nidorina", new PokemonInfo([70, 62, 67, 55, 55, 56], [(int)TypeIndex.Poison], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Nidoqueen", new PokemonInfo([90, 92, 87, 75, 85, 76], [(int)TypeIndex.Poison,(int)TypeIndex.Ground], [], (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            ...
            {"Nidoking", new PokemonInfo([81, 102, 77, 85, 75, 85], [(int)TypeIndex.Poison,(int)TypeIndex.Ground], [], (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            {"Clefairy", new PokemonInfo([70, 45, 48, 60, 65, 35], [(int)TypeIndex.Fairy], [], (int)StageIndex.Basic, (int)ExpTypes.Fast, completed: false)},
            {"Clefable", new PokemonInfo([95, 70, 73, 95, 90, 60], [(int)TypeIndex.Fairy], [], (int)StageIndex.Stage1, (int)ExpTypes.Fast, completed: false)},
            {"Vulpix", new PokemonInfo([38, 41, 40, 50, 65, 65], [(int)TypeIndex.Fire], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Ninetales", new PokemonInfo([73, 76, 75, 81, 100, 100], [(int)TypeIndex.Fire], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Jigglypuff", new PokemonInfo([115, 45, 20, 45, 25, 20], [(int)TypeIndex.Normal,(int)TypeIndex.Fairy], [], (int)StageIndex.Basic, (int)ExpTypes.Fast, completed: false)},
            {"Wigglytuff", new PokemonInfo([140, 70, 45, 85, 50, 45], [(int)TypeIndex.Normal,(int)TypeIndex.Fairy], [], (int)StageIndex.Stage1, (int)ExpTypes.Fast, completed: false)},
            {"Zubat", new PokemonInfo([40, 45, 35, 30, 40, 55], [(int)TypeIndex.Poison,(int)TypeIndex.Flying], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Golbat", new PokemonInfo([75, 80, 70, 65, 75, 90], [(int)TypeIndex.Poison,(int)TypeIndex.Flying], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Oddish",new PokemonInfo( [45, 50, 55, 75, 65, 30], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [], (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, completed: false)},
            {"Gloom", new PokemonInfo([60, 65, 70, 85, 75, 40], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, completed: false)},
            {"Vileplume", new PokemonInfo([75, 80, 85, 110, 90, 50], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [], (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, completed: false)},
            {"Paras", new PokemonInfo([35, 70, 55, 45, 55, 25], [(int)TypeIndex.Bug,(int)TypeIndex.Grass], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"Venonat", new PokemonInfo([60, 55, 50, 40, 55, 45], [(int)TypeIndex.Bug,(int)TypeIndex.Poison], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Diglett", new PokemonInfo([10, 55, 25, 35, 45, 95], [(int)TypeIndex.Ground], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Dugtrio", new PokemonInfo([35, 100, 50, 50, 70, 120], [(int)TypeIndex.Ground], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            {"Meowth", new PokemonInfo([40, 45, 35, 40, 40, 90], [(int)TypeIndex.Normal], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Psyduck", new PokemonInfo([50, 52, 48, 65, 50, 55], [(int)TypeIndex.Water], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Golduck", new PokemonInfo([80, 82, 78, 95, 80, 85], [(int)TypeIndex.Water], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Mankey", new PokemonInfo([40, 80, 35, 35, 45, 70], [(int)TypeIndex.Fighting], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Growlithe", new PokemonInfo([55, 70, 45, 70, 50, 60], [(int)TypeIndex.Fire], [], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Arcanine", new PokemonInfo([90, 110, 80, 100, 80, 95], [(int)TypeIndex.Fire], [], (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},
            {"Poliwag", new PokemonInfo([40, 50, 40, 40, 40, 90], [(int)TypeIndex.Water], [], (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, completed: false)},
            ...
            {"Poliwrath", new PokemonInfo([90, 95, 95, 70, 90, 70], [(int)TypeIndex.Water,(int)TypeIndex.Fighting], [], (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, completed: false)},
            {"Abra", new PokemonInfo([25, 20, 15, 105, 55, 90], [(int)TypeIndex.Psychic], [], (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, completed: false)},
            {"Kadabra", new PokemonInfo([40, 35, 30, 120, 70, 105], [(int)TypeIndex.Psychic], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, completed: false)},
            ...
            {"Machop", new PokemonInfo([70, 80, 50, 35, 35, 35], [(int)TypeIndex.Fighting], [], (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, completed: false)},
            ...
            {"Tentacool", new PokemonInfo([40, 40, 35, 50, 100, 70], [(int)TypeIndex.Water,(int)TypeIndex.Poison], [], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Tentacruel", new PokemonInfo([80, 70, 65, 80, 120, 100], [(int)TypeIndex.Water,(int)TypeIndex.Poison], [], (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},
            {"Geodude", new PokemonInfo([40, 80, 100, 30, 30, 20], [(int)TypeIndex.Rock,(int)TypeIndex.Ground], [], (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, completed: false)},
            ...
            {"Ponyta", new PokemonInfo([50, 85, 55, 65, 65, 90], [(int)TypeIndex.Fire], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Rapidash", new PokemonInfo([65, 100, 70, 80, 80, 105], [(int)TypeIndex.Fire], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Slowpoke", new PokemonInfo([90, 65, 65, 40, 40, 15], [(int)TypeIndex.Water,(int)TypeIndex.Psychic], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Slowbro", new PokemonInfo([95, 75, 110, 100, 80, 30], [(int)TypeIndex.Water,(int)TypeIndex.Psychic], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Farfetch'd", new PokemonInfo([52, 90, 55, 58, 62, 60], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Doduo", new PokemonInfo([35, 85, 45, 35, 35, 75], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [], (int)StageIndex.Basic, completed: false)},
            {"Dodrio", new PokemonInfo([60, 110, 70, 60, 60, 110], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Seel", new PokemonInfo([65, 45, 55, 45, 70, 45], [(int)TypeIndex.Water], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Dewgong", new PokemonInfo([90, 70, 80, 70, 95, 70], [(int)TypeIndex.Water,(int)TypeIndex.Ice], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Grimer", new PokemonInfo([80, 80, 50, 40, 50, 25], [(int)TypeIndex.Poison], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Muk", new PokemonInfo([105, 105, 75, 65, 100, 50], [(int)TypeIndex.Poison], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Shellder", new PokemonInfo([30, 65, 100, 45, 25, 40], [(int)TypeIndex.Water], [], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Cloyster", new PokemonInfo([50, 95, 180, 85, 45, 70], [(int)TypeIndex.Water,(int)TypeIndex.Ice], [], (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},
            ...
            {"Drowzee", new PokemonInfo([60, 48, 45, 43, 90, 42], [(int)TypeIndex.Psychic], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Krabby", new PokemonInfo([30, 105, 90, 25, 25, 50], [(int)TypeIndex.Water], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Kingler", new PokemonInfo([55, 130, 115, 50, 50, 75], [(int)TypeIndex.Water], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Exeggutor", new PokemonInfo([95, 95, 85, 125, 75, 55], [(int)TypeIndex.Grass,(int)TypeIndex.Psychic], [], (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},
            ...
            {"Hitmonlee", new PokemonInfo([50, 120, 53, 35, 110, 87], [(int)TypeIndex.Fighting], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Hitmonchan", new PokemonInfo([50, 105, 79, 35, 110, 76], [(int)TypeIndex.Fighting], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Koffing", new PokemonInfo([40, 65, 95, 60, 45, 35], [(int)TypeIndex.Poison], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"Tangela", new PokemonInfo([65, 55, 115, 100, 40, 60], [(int)TypeIndex.Grass], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Horsea", new PokemonInfo([30, 40, 70, 70, 25, 60], [(int)TypeIndex.Water], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Seadra", new PokemonInfo([55, 65, 95, 95, 45, 85], [(int)TypeIndex.Water], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Goldeen", new PokemonInfo([45, 67, 60, 35, 50, 63], [(int)TypeIndex.Water], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Staryu", new PokemonInfo([30, 45, 55, 70, 55, 85], [(int)TypeIndex.Water], [], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Starmie", new PokemonInfo([60, 75, 85, 100, 85, 115], [(int)TypeIndex.Water,(int)TypeIndex.Psychic], [], (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},
            {"Mr. Mime", new PokemonInfo([40, 45, 65, 100, 120, 90], [(int)TypeIndex.Psychic,(int)TypeIndex.Fairy], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Scyther", new PokemonInfo([70, 110, 80, 55, 80, 105], [(int)TypeIndex.Bug,(int)TypeIndex.Flying], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Jynx", new PokemonInfo([65, 50, 35, 115, 95, 95], [(int)TypeIndex.Ice,(int)TypeIndex.Psychic], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Electabuzz", new PokemonInfo([65, 83, 57, 95, 85, 105], [(int)TypeIndex.Electric], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Magmar", new PokemonInfo([65, 95, 57, 100, 85, 93], [(int)TypeIndex.Fire], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Gyarados", new PokemonInfo([95, 125, 79, 60, 100, 81], [(int)TypeIndex.Water,(int)TypeIndex.Flying], [], (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},
            {"Lapras", new PokemonInfo([130, 85, 80, 85, 95, 60], [(int)TypeIndex.Water,(int)TypeIndex.Ice], [], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            ...
            {"Omanyte", new PokemonInfo([35, 40, 100, 90, 55, 35], [(int)TypeIndex.Rock,(int)TypeIndex.Water], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Omastar", new PokemonInfo([70, 60, 125, 115, 70, 55], [(int)TypeIndex.Rock,(int)TypeIndex.Water], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Kabuto", new PokemonInfo([30, 80, 90, 55, 45, 55], [(int)TypeIndex.Rock,(int)TypeIndex.Water], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Kabutops", new PokemonInfo([60, 115, 105, 65, 70, 80], [(int)TypeIndex.Rock,(int)TypeIndex.Water], [], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Aerodactyl", new PokemonInfo([80, 105, 65, 60, 75, 130], [(int)TypeIndex.Rock,(int)TypeIndex.Flying], [], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Snorlax", new PokemonInfo([160, 110, 65, 65, 110, 30], [(int)TypeIndex.Normal], [], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Articuno", new PokemonInfo([90, 85, 100, 95, 125, 85], [(int)TypeIndex.Ice,(int)TypeIndex.Flying], [], (int)StageIndex.Basic, (int)ExpTypes.Slow, legendary: true, completed: false)},
            {"Zapdos", new PokemonInfo([90, 90, 85, 125, 90, 100], [(int)TypeIndex.Electric,(int)TypeIndex.Flying], [], (int)StageIndex.Basic, (int)ExpTypes.Slow, legendary: true, completed: false)},
            {"Moltres", new PokemonInfo([90, 100, 90, 125, 85, 90], [(int)TypeIndex.Fire,(int)TypeIndex.Flying], [], (int)StageIndex.Basic, (int)ExpTypes.Slow, legendary: true, completed: false)},
            ...
            {"Dragonite", new PokemonInfo([91, 134, 95, 100, 100, 80], [(int)TypeIndex.Dragon,(int)TypeIndex.Flying], [], (int)StageIndex.Stage2, (int)ExpTypes.Slow, completed: false)},
            {"Mewtwo", new PokemonInfo([106, 110, 90, 154, 90, 130], [(int)TypeIndex.Psychic], [], (int)StageIndex.Basic, (int)ExpTypes.Slow, legendary: true, completed: false)},
            {"Mew", new PokemonInfo([100, 100, 100, 100, 100, 100], [(int)TypeIndex.Psychic], [], (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, legendary: true, completed: false)},
            //Gen 2
            ...
            //Gen 5
            {"Joltik", new PokemonInfo([50, 47, 50, 57, 50, 65], [(int)TypeIndex.Bug,(int)TypeIndex.Electric], [], (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            //Gen 7
            {"Zeraora", new PokemonInfo([88, 112, 75, 102, 80, 143], [(int)TypeIndex.Electric], [], (int)StageIndex.Basic, (int)ExpTypes.Slow, legendary: true, completed: false)},
            //Megas
            {"CharizardMegaX", new PokemonInfo([78, 130, 111, 130, 85, 100], [(int)TypeIndex.Fire,(int)TypeIndex.Dragon], [], (int)StageIndex.Mega, (int)ExpTypes.MediumSlow)},
        };
