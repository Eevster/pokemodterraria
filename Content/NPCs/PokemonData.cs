...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Spearow", new PokemonInfo(0021, [40, 60, 30, 31, 31, 70], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("Tackle", 1), new MoveLvl("Gust", 8), new MoveLvl("WingAttack", 18), new MoveLvl("Agility", 25)], [(int)EggGroups.Flying], 0.3f, 2.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            {"Fearow", new PokemonInfo(0022, [65, 90, 65, 61, 61, 100], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("Tackle", 1), new MoveLvl("Gust", 8), new MoveLvl("WingAttack", 18), new MoveLvl("Agility", 27), new MoveLvl("DrillRun", 45)], [(int)EggGroups.Flying], 1.2f, 38.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            {"Pikachu", new PokemonInfo(0025, [35, 55, 40, 50, 50, 90], [(int)TypeIndex.Electric], [new MoveLvl("Tackle"), new MoveLvl("QuickAttack", 1), new MoveLvl("ThunderWave", 4), new MoveLvl("DoubleTeam", 8), new MoveLvl("ElectroBall", 12), new MoveLvl("Slam", 20), new MoveLvl("Agility", 24), new MoveLvl("Discharge", 28), new MoveLvl("Thunderbolt", 36), new MoveLvl("Thunder", 44)], [(int)EggGroups.Field, (int)EggGroups.Fairy], 0.4f, 6.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            {"Raichu", new PokemonInfo(0026, [60, 90, 55, 90, 80, 110], [(int)TypeIndex.Electric], [new MoveLvl("Thunderbolt"), new MoveLvl("Agility", 1), new MoveLvl("QuickAttack", 1), new MoveLvl("DoubleTeam", 1), new MoveLvl("ElectroBall", 1), new MoveLvl("Discharge", 1)], [(int)EggGroups.Field, (int)EggGroups.Fairy], 0.8f, 30.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            {"Jolteon", new PokemonInfo(0135, [65, 65, 60, 110, 95, 130], [(int)TypeIndex.Electric], [new MoveLvl("ThunderWave"), new MoveLvl("Tackle", 1), new MoveLvl("Bite", 1), new MoveLvl("QuickAttack", 10), new MoveLvl("DoubleKick", 20), new MoveLvl("Thunderbolt", 25), new MoveLvl("PinMissile", 30), new MoveLvl("Discharge", 40), new MoveLvl("Agility", 45), new MoveLvl("Thunder", 50)], [(int)EggGroups.Field], 0.8f, 24.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            {"Aerodactyl", new PokemonInfo(0142, [80, 105, 65, 60, 75, 130], [(int)TypeIndex.Rock,(int)TypeIndex.Flying], [new MoveLvl("AncientPower"), new MoveLvl("Bite"), new MoveLvl("WingAttack", 10), new MoveLvl("RockSlide", 24), new MoveLvl("Crunch", 30), new MoveLvl("Agility", 50), new MoveLvl("HyperBeam", 55)], [(int)EggGroups.Flying], 1.8f, 59.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow, artist: "RollinMan")},
            ...
            {"Dragonite", new PokemonInfo(0149, [91, 134, 95, 100, 100, 80], [(int)TypeIndex.Dragon,(int)TypeIndex.Flying], [new MoveLvl("Hurricane"), new MoveLvl("Tackle", 1), new MoveLvl("ThunderWave", 5), new MoveLvl("Gust", 10), new MoveLvl("DragonTail", 15), new MoveLvl("Agility", 20), new MoveLvl("Slam", 25), new MoveLvl("AquaTail", 33), new MoveLvl("WaterPulse", 36), new MoveLvl("DragonRush", 48), new MoveLvl("ExtremeSpeed", 50), new MoveLvl("HyperBeam", 64)], [(int)EggGroups.Water1, (int)EggGroups.Dragon], 2.2f, 210.0f, (int)StageIndex.Stage2, (int)ExpTypes.Slow, artist: "JACSMITH")},
