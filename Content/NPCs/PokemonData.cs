...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Vaporeon", new PokemonInfo(0134, [130, 65, 60, 110, 95, 65], [(int)TypeIndex.Water], [new MoveLvl("WaterGun"), new MoveLvl("Tackle", 1), new MoveLvl("Bite", 1), new MoveLvl("QuickAttack", 10), new MoveLvl("IceFang", 20), new MoveLvl("WaterPulse", 25), new MoveLvl("AuroraBeam", 30), new MoveLvl("AquaRing", 35), new MoveLvl("Waterfall", 40), new MoveLvl("AcidArmor", 45), new MoveLvl("HydroPump", 50)], [(int)EggGroups.Field], 1.0f, 29.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
