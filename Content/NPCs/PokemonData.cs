...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"MimeJr", new PokemonInfo(0439, [20, 25, 45, 70, 90, 60], [(int)TypeIndex.Psychic, (int)TypeIndex.Fairy], [new MoveLvl("Tackle"), new MoveLvl("ConfuseRay", 1), new MoveLvl("Confusion", 8)], [(int)EggGroups.NoEggs], 0.6f, 13.0f, (int)StageIndex.Baby, (int)ExpTypes.MediumFast, artist: "Fiona")},
            ...
            {"Litwick", new PokemonInfo(0607, [50, 30, 55, 65, 50, 20], [(int)TypeIndex.Ghost,(int)TypeIndex.Fire], [new MoveLvl("Ember"), new MoveLvl("Smokescreen"), new MoveLvl("ConfuseRay", 12), new MoveLvl("AcidArmor", 16), new MoveLvl("Flamethrower", 28), new MoveLvl("ShadowBall", 32), new MoveLvl("FlameWheel", 38), new MoveLvl("OverHeat", 52)], [(int)EggGroups.Amorphous], 0.3f, 3.1f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, artist: "Kerpi")},
            {"Lampent", new PokemonInfo(0608, [60, 40, 60, 95, 60, 55], [(int)TypeIndex.Ghost,(int)TypeIndex.Fire], [new MoveLvl("Ember"), new MoveLvl("Smokescreen"), new MoveLvl("ConfuseRay", 12), new MoveLvl("AcidArmor", 16), new MoveLvl("Flamethrower", 28), new MoveLvl("ShadowBall", 32), new MoveLvl("FlameWheel", 38), new MoveLvl("OverHeat", 52)], [(int)EggGroups.Amorphous], 0.6f, 13.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, artist: "Kerpi")},
            {"Chandelure", new PokemonInfo(0609, [60, 55, 90, 145, 90, 80], [(int)TypeIndex.Ghost,(int)TypeIndex.Fire], [new MoveLvl("Ember"), new MoveLvl("Smokescreen"), new MoveLvl("ConfuseRay", 12), new MoveLvl("AcidArmor", 16), new MoveLvl("Flamethrower", 28), new MoveLvl("ShadowBall", 32), new MoveLvl("FlameWheel", 38), new MoveLvl("OverHeat", 52)], [(int)EggGroups.Amorphous], 1.0f, 34.3f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "Kerpi")},
            ...
            //Gen 9
            {"Tinkatink", new PokemonInfo(0957, [50, 45, 45, 35, 64, 58], [(int)TypeIndex.Fairy], [new MoveLvl("Tackle"), new MoveLvl("RockThrow", 10), new MoveLvl("Screech", 20), new MoveLvl("FlashCannon", 31)], [(int)EggGroups.Fairy], 0.4f, 8.9f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, artist: "Dusk")},
            {"Tinkatuff", new PokemonInfo(0958, [65, 55, 55, 45, 82, 78], [(int)TypeIndex.Fairy,(int)TypeIndex.Steel], [new MoveLvl("Tackle"), new MoveLvl("RockThrow", 10), new MoveLvl("Screech", 20), new MoveLvl("FlashCannon", 31)], [(int)EggGroups.Fairy], 0.7f, 59.1f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, artist: "Dusk")},
            {"Tinkaton", new PokemonInfo(0959, [85, 75, 77, 70, 105, 94], [(int)TypeIndex.Fairy,(int)TypeIndex.Steel], [new MoveLvl("Tackle"), new MoveLvl("RockThrow", 10), new MoveLvl("Screech", 20), new MoveLvl("FlashCannon", 31)], [(int)EggGroups.Fairy], 0.7f, 112.8f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "Dusk")},

            {"Orthworm", new PokemonInfo(0968, [70, 85, 145, 60, 55, 65], [(int)TypeIndex.Steel], [new MoveLvl("Tackle", 1), new MoveLvl("Harden", 1), new MoveLvl("MudSlap", 7), new MoveLvl("TakeDown", 26), new MoveLvl("Dig", 30), new MoveLvl("Earthquake", 47)], [(int)EggGroups.Field], 2.5f, 310.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false, artist: "JACSMITH")},
            ...
            {"TerrarianKabuto", new PokemonInfo(0140, [30, 85, 50, 50, 50, 90], [(int)TypeIndex.Rock,(int)TypeIndex.Ghost], [new MoveLvl("Harden"), new MoveLvl("Tackle", 5), new MoveLvl("ConfuseRay", 15), new MoveLvl("NightSlash", 25), new MoveLvl("AncientPower", 30), new MoveLvl("RockSlide", 42), new MoveLvl("FuryCutter", 47), new MoveLvl("ExtremeSpeed", 52)], [(int)EggGroups.Amorphous], 0.5f, 1.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "RollinMan")},
            {"TerrarianKabutops", new PokemonInfo(0141, [60, 110, 65, 65, 70, 125], [(int)TypeIndex.Rock,(int)TypeIndex.Ghost], [new MoveLvl("Hex"), new MoveLvl("Harden", 1), new MoveLvl("Tackle", 5), new MoveLvl("ConfuseRay", 15), new MoveLvl("NightSlash", 25), new MoveLvl("AncientPower", 30), new MoveLvl("RockSlide", 45), new MoveLvl("FuryCutter", 50), new MoveLvl("ExtremeSpeed", 60)],  [(int)EggGroups.Amorphous], 1.3f, 4.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "RollinMan")},
