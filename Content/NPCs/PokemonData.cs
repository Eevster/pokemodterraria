...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"AmpharosMega", new PokemonInfo(0181, [90, 95, 105, 165, 110, 45], [(int)TypeIndex.Electric], [new MoveLvl("Discharge")], [(int)EggGroups.NoEggs], 1.4f, 61.5f, (int)StageIndex.Mega, (int)ExpTypes.MediumSlow, artist: "Kerpi")},
