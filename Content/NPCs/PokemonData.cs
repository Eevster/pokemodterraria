...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData{
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Dragonair", new PokemonInfo([61, 84, 65, 70, 70, 70], [(int)TypeIndex.Dragon], ["ThunderWave"], (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},
            {"Dragonite", new PokemonInfo([91, 134, 95, 100, 100, 80], [(int)TypeIndex.Dragon,(int)TypeIndex.Flying], ["WingAttack", "HyperBeam"], (int)StageIndex.Stage2, (int)ExpTypes.Slow, completed: false)},
        ...
        public static Dictionary<string, PokemonAttackInfo> pokemonAttacks = new(){
            ...
            {"HyperBeam", new PokemonAttackInfo(150,35,95,800f,false,true,(int)TypeIndex.Normal, true)},
