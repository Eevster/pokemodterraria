...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Spearow", new PokemonInfo(0021, [40, 60, 30, 31, 31, 70], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("Tackle", 1), new MoveLvl("Gust", 8), new MoveLvl("WingAttack", 18)], [(int)EggGroups.Flying], 0.3f, 2.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            {"Fearow", new PokemonInfo(0022, [65, 90, 65, 61, 61, 100], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("Tackle", 1), new MoveLvl("Gust", 8), new MoveLvl("WingAttack", 18), new MoveLvl("DrillRun", 45)], [(int)EggGroups.Flying], 1.2f, 38.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            {"Kadabra", new PokemonInfo(0064, [40, 35, 30, 120, 70, 105], [(int)TypeIndex.Psychic], [new MoveLvl("Confusion"), new MoveLvl("Teleport"), new MoveLvl("Psybeam", 24), new MoveLvl("Recover", 30), new MoveLvl("PsychoCut", 34), new MoveLvl("Psychic", 40)], [(int)EggGroups.HumanLike], 1.3f, 56.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, artist: "RollinMan")},
            {"Alakazam", new PokemonInfo(0065, [55, 50, 45, 135, 95, 120], [(int)TypeIndex.Psychic], [new MoveLvl("Confusion", 1), new MoveLvl("Teleport", 1), new MoveLvl("Psybeam", 24), new MoveLvl("Recover", 30), new MoveLvl("PsychoCut", 34), new MoveLvl("Psychic", 40)], [(int)EggGroups.HumanLike], 1.5f, 48.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "RollinMan")},
            ...
            {"Slowpoke", new PokemonInfo(0079, [90, 65, 65, 40, 40, 15], [(int)TypeIndex.Water,(int)TypeIndex.Psychic], [new MoveLvl("Confusion")], [(int)EggGroups.Monster, (int)EggGroups.Water1], 1.2f, 36.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false, artist: "Kerpi")},
            {"Slowbro", new PokemonInfo(0080, [95, 75, 110, 100, 80, 30], [(int)TypeIndex.Water,(int)TypeIndex.Psychic], [new MoveLvl("ConfuseRay")], [(int)EggGroups.Monster, (int)EggGroups.Water1], 1.6f, 78.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false, artist: "Kerpi")},
            ...
            {"Shellder", new PokemonInfo(0090, [30, 65, 100, 45, 25, 40], [(int)TypeIndex.Water], [new MoveLvl("Tackle"), new MoveLvl("IceShard", 8), new MoveLvl("WaterGun", 12), new MoveLvl("Harden", 18), new MoveLvl("BubbleBeam", 24), new MoveLvl("Slash", 32), new MoveLvl("IceBeam", 40), new MoveLvl("HydroPump", 48)], [(int)EggGroups.Water3], 0.3f, 4.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow, artist: "Fiona")},
            ...
            {"Gengar", new PokemonInfo(0094, [60, 65, 60, 130, 75, 110], [(int)TypeIndex.Ghost,(int)TypeIndex.Poison], [new MoveLvl("Toxic", 1), new MoveLvl("ConfuseRay", 1), new MoveLvl("Confusion", 12), new MoveLvl("Hex", 20), new MoveLvl("NightShade", 32), new MoveLvl("Crunch", 40), new MoveLvl("ShadowBall", 48)], [(int)EggGroups.Amorphous], 1.5f, 40.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, artist: "RollinMan")},
            ...
            {"Koffing", new PokemonInfo(0109, [40, 65, 95, 60, 45, 35], [(int)TypeIndex.Poison], [new MoveLvl("Tackle"), new MoveLvl("PoisonPowder"), new MoveLvl("Smokescreen", 8), new MoveLvl("Crunch", 16), new MoveLvl("SelfDestruct", 24), new MoveLvl("SludgeBomb", 32), new MoveLvl("Toxic", 36), new MoveLvl("Explosion", 44)], [(int)EggGroups.Amorphous], 0.6f, 1.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
            ...
            {"Aerodactyl", new PokemonInfo(0142, [80, 105, 65, 60, 75, 130], [(int)TypeIndex.Rock,(int)TypeIndex.Flying], [new MoveLvl("AncientPower"), new MoveLvl("Bite"), new MoveLvl("WingAttack", 10), new MoveLvl("RockSlide", 24), new MoveLvl("Crunch", 30), new MoveLvl("HyperBeam", 55)], [(int)EggGroups.Flying], 1.8f, 59.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow, artist: "RollinMan")},
            ...
            {"Dratini", new PokemonInfo(0147, [41, 64, 45, 50, 50, 50], [(int)TypeIndex.Dragon], [new MoveLvl("Tackle"), new MoveLvl("ThunderWave", 5), new MoveLvl("Gust", 10), new MoveLvl("DragonTail", 15), new MoveLvl("Slam", 25), new MoveLvl("AquaTail", 31), new MoveLvl("WaterPulse", 35), new MoveLvl("DragonRush", 45), new MoveLvl("HyperBeam", 55)], [(int)EggGroups.Water1, (int)EggGroups.Dragon], 1.8f, 3.3f, (int)StageIndex.Basic, (int)ExpTypes.Slow, artist: "JACSMITH")},
            ...
            {"Mareep", new PokemonInfo(0179, [55, 40, 40, 65, 45, 35], [(int)TypeIndex.Electric], [new MoveLvl("Tackle", 1), new MoveLvl("ThunderWave", 6), new MoveLvl("ConfuseRay", 14), new MoveLvl("ElectroBall", 22), new MoveLvl("PowerGem", 30), new MoveLvl("Discharge", 38), new MoveLvl("Thunder", 46)], [(int)EggGroups.Monster, (int)EggGroups.Field], 0.6f, 7.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, artist: "Kerpi")},
            {"Flaaffy", new PokemonInfo(0180, [70, 55, 55, 80, 60, 45], [(int)TypeIndex.Electric], [new MoveLvl("Tackle", 1), new MoveLvl("ThunderWave", 6), new MoveLvl("ConfuseRay", 14), new MoveLvl("ElectroBall", 25), new MoveLvl("PowerGem", 35), new MoveLvl("Discharge", 45), new MoveLvl("Thunder", 55)], [(int)EggGroups.Monster, (int)EggGroups.Field], 0.6f, 7.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, completed: false, artist: "Kerpi")},
            {"Ampharos", new PokemonInfo(0181, [90, 75, 75, 115, 90, 55], [(int)TypeIndex.Electric], [new MoveLvl("Thunderbolt"), new MoveLvl("Tackle", 1), new MoveLvl("ThunderWave", 6), new MoveLvl("ConfuseRay", 14), new MoveLvl("ElectroBall", 25), new MoveLvl("PowerGem", 35), new MoveLvl("Discharge", 50), new MoveLvl("Thunder", 65)], [(int)EggGroups.Monster, (int)EggGroups.Field], 0.6f, 7.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, completed: false, artist: "Kerpi")},
            ...
            {"Jumpluff", new PokemonInfo(0189, [75, 55, 70, 55, 85, 110], [(int)TypeIndex.Grass, (int)TypeIndex.Flying], [new MoveLvl("LeafStorm"), new MoveLvl("Tackle", 1), new MoveLvl("RazorLeaf", 6), new MoveLvl("PoisonPowder", 9), new MoveLvl("AquaRing", 18), new MoveLvl("MagicalLeaf", 22), new MoveLvl("LeechSeed", 26), new MoveLvl("Slam", 40), new MoveLvl("HealPulse", 54), new MoveLvl("SolarBeam", 66), new MoveLvl("LeafBlade", 70)], [(int)EggGroups.Fairy, (int)EggGroups.Grass], 0.8f, 3.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, completed: false, artist: "Kerpi")},

            {"Wooper", new PokemonInfo(0194, [55, 45, 45, 25, 25, 15], [(int)TypeIndex.Water, (int)TypeIndex.Ground], [new MoveLvl("Tackle")], [(int)EggGroups.Water1, (int)EggGroups.Field], 0.4f, 8.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false, artist: "Kerpi")},
            {"Quagsire", new PokemonInfo(0195, [95, 85, 85, 65, 65, 35], [(int)TypeIndex.Water, (int)TypeIndex.Ground], [new MoveLvl("Tackle")], [(int)EggGroups.Water1, (int)EggGroups.Field], 1.4f, 75.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false, artist: "Kerpi")},
            ...
            //Gen 4
            {"Cranidos", new PokemonInfo(0408, [67, 125, 40, 30, 30, 58], [(int)TypeIndex.Rock], [new MoveLvl("Tackle"), new MoveLvl("Harden", 8), new MoveLvl("Bite", 16), new MoveLvl("Slam", 22), new MoveLvl("AncientPower", 28), new MoveLvl("PsychoCut", 35), new MoveLvl("DoubleEdge", 40), new MoveLvl("StoneEdge", 45)], [(int)EggGroups.Monster], 0.9f, 31.5f, (int)StageIndex.Basic, (int)ExpTypes.Erratic, artist: "Digibeast")},
            ...
            //Gen 5
            {"Joltik", new PokemonInfo(0595, [50, 47, 50, 57, 50, 65], [(int)TypeIndex.Bug,(int)TypeIndex.Electric], [new MoveLvl("FuryCutter"), new MoveLvl("StringShot", 8), new MoveLvl("ThunderWave", 16), new MoveLvl("ElectroBall", 20), new MoveLvl("Crunch", 26), new MoveLvl("Slash", 32), new MoveLvl("Discharge", 37), new MoveLvl("PinMissile", 44)], [(int)EggGroups.Bug], 0.1f, 0.6f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, artist: "JACSMITH")},
