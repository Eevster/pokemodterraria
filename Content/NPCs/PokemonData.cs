...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData{
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Butterfree", new PokemonInfo([60, 45, 50, 90, 80, 70], [(int)TypeIndex.Bug,(int)TypeIndex.Flying], ["Psybeam", "AirSlash"], (int)StageIndex.Stage2, (int)ExpTypes.MediumFast)},
            ...
            {"Beedrill", new PokemonInfo([65, 90, 40, 45, 80, 75], [(int)TypeIndex.Bug,(int)TypeIndex.Poison], ["PinMissile", "SludgeBomb"], (int)StageIndex.Stage2, (int)ExpTypes.MediumFast)},
            ...
            {"Ekans", new PokemonInfo([35, 60, 44, 40, 54, 55], [(int)TypeIndex.Poison], ["PoisonSting"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Arbok", new PokemonInfo([60, 95, 69, 65, 79, 80], [(int)TypeIndex.Poison], ["SludgeBomb"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Sandslash", new PokemonInfo([75, 100, 110, 45, 55, 65], [(int)TypeIndex.Ground], ["Dig", "MudShot"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Nidoqueen", new PokemonInfo([90, 92, 87, 75, 85, 76], [(int)TypeIndex.Poison,(int)TypeIndex.Ground], ["FocusPunch", "Toxic"], (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            {"NidoranM", new PokemonInfo([55, 47, 52, 40, 40, 41], [(int)TypeIndex.Poison], ["DoubleKick"], (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Nidorino", new PokemonInfo([61, 72, 57, 55, 55, 65], [(int)TypeIndex.Poison], ["PoisonSting"], (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Nidoking", new PokemonInfo([81, 102, 77, 85, 75, 85], [(int)TypeIndex.Poison,(int)TypeIndex.Ground], ["Earthquake", "Toxic"], (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            {"Clefairy", new PokemonInfo([70, 45, 48, 60, 65, 35], [(int)TypeIndex.Fairy], ["Tackle"], (int)StageIndex.Basic, (int)ExpTypes.Fast, completed: false)},
            {"Clefable", new PokemonInfo([95, 70, 73, 95, 90, 60], [(int)TypeIndex.Fairy], ["HealPulse", "Tackle"], (int)StageIndex.Stage1, (int)ExpTypes.Fast, completed: false)},
            {"Vulpix", new PokemonInfo([38, 41, 40, 50, 65, 65], [(int)TypeIndex.Fire], ["Ember", "Tackle"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Jigglypuff", new PokemonInfo([115, 45, 20, 45, 25, 20], [(int)TypeIndex.Normal,(int)TypeIndex.Fairy], ["Tackle"], (int)StageIndex.Basic, (int)ExpTypes.Fast, completed: false)},
            {"Wigglytuff", new PokemonInfo([140, 70, 45, 85, 50, 45], [(int)TypeIndex.Normal,(int)TypeIndex.Fairy], ["DoubleEdge", "Swift"], (int)StageIndex.Stage1, (int)ExpTypes.Fast, completed: false)},
            ...
            {"Gloom", new PokemonInfo([60, 65, 70, 85, 75, 40], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], ["Toxic","MegaDrain"], (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, completed: false)},
            ...
            {"Paras", new PokemonInfo([35, 70, 55, 45, 55, 25], [(int)TypeIndex.Bug,(int)TypeIndex.Grass], ["FuryCutter"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Parasect", new PokemonInfo([60, 95, 80, 60, 80, 30], [(int)TypeIndex.Bug,(int)TypeIndex.Grass], ["PoisonPowder"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            ...
            {"Venomoth", new PokemonInfo([70, 65, 60, 90, 75, 90], [(int)TypeIndex.Bug,(int)TypeIndex.Poison], ["Psychic"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Diglett", new PokemonInfo([10, 55, 25, 35, 45, 95], [(int)TypeIndex.Ground], ["Dig"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Dugtrio", new PokemonInfo([35, 100, 50, 50, 70, 120], [(int)TypeIndex.Ground], ["Earthquake"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            {"Meowth", new PokemonInfo([40, 45, 35, 40, 40, 90], [(int)TypeIndex.Normal], ["Tackle"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Persian", new PokemonInfo([65, 70, 60, 65, 65, 115], [(int)TypeIndex.Normal], ["HyperFang"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Mankey", new PokemonInfo([40, 80, 35, 35, 45, 70], [(int)TypeIndex.Fighting], ["Tackle"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Primeape", new PokemonInfo([65, 105, 60, 60, 70, 95], [(int)TypeIndex.Fighting], ["DoubleKick"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Machop", new PokemonInfo([70, 80, 50, 35, 35, 35], [(int)TypeIndex.Fighting], ["Tackle"], (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, completed: false)},
            {"Machoke", new PokemonInfo([80, 100, 70, 50, 60, 45], [(int)TypeIndex.Fighting], ["DoubleKick"], (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, completed: false)},
            {"Machamp", new PokemonInfo([90, 130, 80, 65, 85, 55], [(int)TypeIndex.Fighting], ["FocusPunch"], (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, completed: false)},
            ...
            {"Weepinbell", new PokemonInfo([65, 90, 50, 85, 45, 55], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], ["BulletSeed"], (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Victreebel", new PokemonInfo([80, 105, 65, 100, 70, 70], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], ["LeafBlade","LeafStorm"], (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            ...
            {"Geodude", new PokemonInfo([40, 80, 100, 30, 30, 20], [(int)TypeIndex.Rock,(int)TypeIndex.Ground], ["Tackle", "SelfDestruct"], (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Graveler", new PokemonInfo([55, 95, 115, 45, 45, 35], [(int)TypeIndex.Rock,(int)TypeIndex.Ground], ["RockThrow"], (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Golem", new PokemonInfo([80, 120, 130, 55, 65, 45], [(int)TypeIndex.Rock,(int)TypeIndex.Ground], ["Earthquake"], (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            ...
            {"Farfetchd", new PokemonInfo([52, 90, 55, 58, 62, 60], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], ["Swift"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Doduo", new PokemonInfo([35, 85, 45, 35, 35, 75], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], ["QuickAttack"], (int)StageIndex.Basic, completed: false)},
            ...
            {"Grimer", new PokemonInfo([80, 80, 50, 40, 50, 25], [(int)TypeIndex.Poison], ["MudShot"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Muk", new PokemonInfo([105, 105, 75, 65, 100, 50], [(int)TypeIndex.Poison], ["SludgeBomb"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Cloyster", new PokemonInfo([50, 95, 180, 85, 45, 70], [(int)TypeIndex.Water,(int)TypeIndex.Ice], ["HydroPump", "IceFang"], (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},
            ...
            {"Gengar", new PokemonInfo([60, 65, 60, 130, 75, 110], [(int)TypeIndex.Ghost,(int)TypeIndex.Poison], ["NightShade"], (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            {"Onix", new PokemonInfo([35, 45, 160, 30, 45, 70], [(int)TypeIndex.Rock,(int)TypeIndex.Ground], ["RockThrow", "Earthquake"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Hypno", new PokemonInfo([85, 73, 70, 73, 115, 67], [(int)TypeIndex.Psychic], ["Psybeam", "Psychic"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Voltorb", new PokemonInfo([40, 30, 50, 55, 55, 100], [(int)TypeIndex.Electric], ["Tackle", "SelfDestruct"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Electrode", new PokemonInfo([60, 50, 70, 80, 80, 150], [(int)TypeIndex.Electric], ["Explosion", "Discharge"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            {"Exeggcute", new PokemonInfo([60, 40, 80, 60, 45, 40], [(int)TypeIndex.Grass,(int)TypeIndex.Psychic], ["Confusion"], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            ...
            {"Cubone", new PokemonInfo([50, 50, 95, 40, 50, 35], [(int)TypeIndex.Ground], ["Tackle"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Marowak", new PokemonInfo([60, 80, 110, 50, 80, 45], [(int)TypeIndex.Ground], ["Earthquake"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Chansey", new PokemonInfo([250, 5, 5, 35, 105, 50], [(int)TypeIndex.Normal], ["HealPulse", "Tackle", "DoubleEdge"], (int)StageIndex.Basic, (int)ExpTypes.Fast)},
            ...
            {"Kangaskhan", new PokemonInfo([105, 95, 80, 40, 80, 90], [(int)TypeIndex.Normal], ["Tackle"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Seadra", new PokemonInfo([55, 65, 95, 95, 45, 85], [(int)TypeIndex.Water], ["HydroPump", "DragonBreath"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            {"Goldeen", new PokemonInfo([45, 67, 60, 35, 50, 63], [(int)TypeIndex.Water], ["BubbleBeam"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Seaking", new PokemonInfo([80, 92, 65, 65, 80, 68], [(int)TypeIndex.Water], ["WaterPulse"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"MrMime", new PokemonInfo([40, 45, 65, 100, 120, 90], [(int)TypeIndex.Psychic,(int)TypeIndex.Fairy], ["Confusion"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Scyther", new PokemonInfo([70, 110, 80, 55, 80, 105], [(int)TypeIndex.Bug,(int)TypeIndex.Flying], ["FuryCutter"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Pinsir", new PokemonInfo([65, 125, 100, 55, 70, 85], [(int)TypeIndex.Bug], ["FuryCutter"], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Tauros", new PokemonInfo([75, 100, 95, 40, 70, 110], [(int)TypeIndex.Normal], ["Tackle", "DoubleEdge"], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Magikarp", new PokemonInfo([20, 10, 55, 15, 20, 80], [(int)TypeIndex.Water], ["Splash"], (int)StageIndex.Basic, (int)ExpTypes.Slow)},
            {"Gyarados", new PokemonInfo([95, 125, 79, 60, 100, 81], [(int)TypeIndex.Water,(int)TypeIndex.Flying], ["HydroPump", "IceFang"], (int)StageIndex.Stage1, (int)ExpTypes.Slow)},
            ...
            {"Ditto", new PokemonInfo([48, 48, 48, 48, 48, 48], [(int)TypeIndex.Normal], ["Swift"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Porygon", new PokemonInfo([65, 60, 70, 85, 75, 40], [(int)TypeIndex.Normal], ["Discharge"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Kabuto", new PokemonInfo([30, 80, 90, 55, 45, 55], [(int)TypeIndex.Rock,(int)TypeIndex.Water], ["Tackle"], (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Aerodactyl", new PokemonInfo([80, 105, 65, 60, 75, 130], [(int)TypeIndex.Rock,(int)TypeIndex.Flying], ["WingAttack", "HyperBeam"], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Snorlax", new PokemonInfo([160, 110, 65, 65, 110, 30], [(int)TypeIndex.Normal], ["DoubleEdge", "HyperBeam"], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Articuno", new PokemonInfo([90, 85, 100, 95, 125, 85], [(int)TypeIndex.Ice,(int)TypeIndex.Flying], ["IceFang", "HydroPump"], (int)StageIndex.Basic, (int)ExpTypes.Slow, legendary: true, completed: false)},
            {"Zapdos", new PokemonInfo([90, 90, 85, 125, 90, 100], [(int)TypeIndex.Electric,(int)TypeIndex.Flying], ["Thunder", "Thunderbolt"], (int)StageIndex.Basic, (int)ExpTypes.Slow, legendary: true, completed: false)},
            {"Moltres", new PokemonInfo([90, 100, 90, 125, 85, 90], [(int)TypeIndex.Fire,(int)TypeIndex.Flying], ["LavaPlume", "FlameThrower"], (int)StageIndex.Basic, (int)ExpTypes.Slow, legendary: true, completed: false)},
            {"Dratini", new PokemonInfo([41, 64, 45, 50, 50, 50], [(int)TypeIndex.Dragon], ["Swift"], (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            {"Dragonair", new PokemonInfo([61, 84, 65, 70, 70, 70], [(int)TypeIndex.Dragon], ["WingAttack"], (int)StageIndex.Stage1, (int)ExpTypes.Slow, completed: false)},
            {"Dragonite", new PokemonInfo([91, 134, 95, 100, 100, 80], [(int)TypeIndex.Dragon,(int)TypeIndex.Flying], ["DragonBreath", "HyperBeam"], (int)StageIndex.Stage2, (int)ExpTypes.Slow, completed: false)},
            {"Mewtwo", new PokemonInfo([106, 110, 90, 154, 90, 130], [(int)TypeIndex.Psychic], ["Psychic"], (int)StageIndex.Basic, (int)ExpTypes.Slow, legendary: true, completed: false)},
            {"Mew", new PokemonInfo([100, 100, 100, 100, 100, 100], [(int)TypeIndex.Psychic], ["Psychic"], (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, legendary: true, completed: false)},
            //Gen 2
            ...
            {"Galvantula", new PokemonInfo([70, 77, 60, 97, 60, 108], [(int)TypeIndex.Bug,(int)TypeIndex.Electric], ["Thunder"], (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            //Gen 7
            ...
            {"CharizardMegaX", new PokemonInfo([78, 130, 111, 130, 85, 100], [(int)TypeIndex.Fire,(int)TypeIndex.Dragon], ["DragonBreath"], (int)StageIndex.Mega, (int)ExpTypes.MediumSlow)},
            ...
            {"GengarMega", new PokemonInfo([60, 65, 80, 170, 95, 130], [(int)TypeIndex.Ghost,(int)TypeIndex.Poison], ["ShadowBall"], (int)StageIndex.Mega, (int)ExpTypes.MediumSlow)},
            {"GyaradosMega", new PokemonInfo([95, 155, 109, 70, 130, 81], [(int)TypeIndex.Water,(int)TypeIndex.Dark], ["HyperBeam"], (int)StageIndex.Mega, (int)ExpTypes.Slow)},
