...
namespace Pokemod.Content.NPCs
{
    ...
    internal class PokemonData
    {
        public static Dictionary<string, PokemonInfo> pokemonInfo = new(){
            ...
            {"Squirtle", new PokemonInfo(0007,[44, 48, 65, 50, 64, 43], [(int)TypeIndex.Water], [new MoveLvl("Tackle"), new MoveLvl("WaterGun", 3), new MoveLvl("WaterPulse", 12), new MoveLvl("Bite", 15), new MoveLvl("Harden", 18), new MoveLvl("AquaTail", 24), new MoveLvl("Waterfall", 30), new MoveLvl("HydroPump", 33), new MoveLvl("DoubleEdge", 36)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 0.5f, 9.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            ...
            {"Blastoise", new PokemonInfo(0009, [79, 83, 100, 85, 105, 78], [(int)TypeIndex.Water], [new MoveLvl("FlashCannon"), new MoveLvl("Tackle", 1), new MoveLvl("WaterGun", 1), new MoveLvl("WaterPulse", 12), new MoveLvl("Bite", 15), new MoveLvl("Harden", 20), new MoveLvl("AquaTail", 30), new MoveLvl("Waterfall", 42), new MoveLvl("HydroPump", 49), new MoveLvl("DoubleEdge", 56)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 1.6f, 85.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            ...
            {"Rattata", new PokemonInfo(0019, [30, 56, 35, 25, 35, 72], [(int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("QuickAttack", 4), new MoveLvl("Bite", 22), new MoveLvl("HyperFang", 28), new MoveLvl("DoubleEdge", 31)], [(int)EggGroups.Field], 0.3f, 3.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"Spearow", new PokemonInfo(0021, [40, 60, 30, 31, 31, 70], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("Tackle", 1), new MoveLvl("Gust", 8), new MoveLvl("WingAttack", 18)], [(int)EggGroups.Flying], 0.3f, 2.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Fearow", new PokemonInfo(0022, [65, 90, 65, 61, 61, 100], [(int)TypeIndex.Normal,(int)TypeIndex.Flying], [new MoveLvl("Tackle", 1), new MoveLvl("Gust", 8), new MoveLvl("WingAttack", 18), new MoveLvl("DrillRun", 45)], [(int)EggGroups.Flying], 1.2f, 38.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            ...
            {"Pikachu", new PokemonInfo(0025, [35, 55, 40, 50, 50, 90], [(int)TypeIndex.Electric], [new MoveLvl("Tackle"), new MoveLvl("ThunderWave", 4), new MoveLvl("QuickAttack", 8), new MoveLvl("ElectroBall", 12), new MoveLvl("Slam", 20), new MoveLvl("Discharge", 28), new MoveLvl("Thunderbolt", 36), new MoveLvl("Thunder", 44)], [(int)EggGroups.Field, (int)EggGroups.Fairy], 0.4f, 6.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"Nidoqueen", new PokemonInfo(0031, [90, 92, 87, 75, 85, 76], [(int)TypeIndex.Poison,(int)TypeIndex.Ground], [new MoveLvl("FocusPunch")], [(int)EggGroups.NoEggs], 1.3f, 60.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},

            {"NidoranM", new PokemonInfo(0032, [55, 47, 52, 40, 40, 41], [(int)TypeIndex.Poison], [new MoveLvl("PoisonSting"), new MoveLvl("Tackle", 16), new MoveLvl("DoubleKick", 25), new MoveLvl("Bite", 30), new MoveLvl("Toxic", 40), new MoveLvl("SludgeBomb", 50), new MoveLvl("Earthquake", 55)], [(int)EggGroups.Monster, (int)EggGroups.Field], 0.5f, 9.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            ...
            {"Nidoking", new PokemonInfo(0034, [81, 102, 77, 85, 75, 85], [(int)TypeIndex.Poison,(int)TypeIndex.Ground], [new MoveLvl("FocusPunch")], [(int)EggGroups.Monster, (int)EggGroups.Field], 1.4f, 62.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},

            {"Clefairy", new PokemonInfo(0035, [70, 45, 48, 60, 65, 35], [(int)TypeIndex.Fairy], [new MoveLvl("Tackle", 1), new MoveLvl("Harden", 12), new MoveLvl("HealPulse", 24), new MoveLvl("Slam", 36), new MoveLvl("Psychic", 48)], [(int)EggGroups.Fairy], 0.6f, 7.5f, (int)StageIndex.Basic, (int)ExpTypes.Fast)},
            {"Clefable", new PokemonInfo(0036, [95, 70, 73, 95, 90, 60], [(int)TypeIndex.Fairy], [new MoveLvl("Tackle", 1), new MoveLvl("Harden", 12), new MoveLvl("HealPulse", 24), new MoveLvl("Slam", 36), new MoveLvl("Psychic", 48)], [(int)EggGroups.Fairy], 1.3f, 40.0f, (int)StageIndex.Stage1, (int)ExpTypes.Fast)},
            ...
            {"Jigglypuff", new PokemonInfo(0039, [115, 45, 20, 45, 25, 20], [(int)TypeIndex.Normal,(int)TypeIndex.Fairy], [new MoveLvl("Tackle", 1), new MoveLvl("Harden", 12), new MoveLvl("Swift", 20), new MoveLvl("HealPulse", 28), new MoveLvl("Slam", 36), new MoveLvl("DoubleEdge", 44)], [(int)EggGroups.Fairy], 0.5f, 5.5f, (int)StageIndex.Basic, (int)ExpTypes.Fast)},
            {"Wigglytuff", new PokemonInfo(0040, [140, 70, 45, 85, 50, 45], [(int)TypeIndex.Normal,(int)TypeIndex.Fairy], [new MoveLvl("Tackle", 1), new MoveLvl("Harden", 12), new MoveLvl("Swift", 20), new MoveLvl("HealPulse", 28), new MoveLvl("Slam", 36), new MoveLvl("DoubleEdge", 44)], [(int)EggGroups.Fairy], 1.0f, 12.0f, (int)StageIndex.Stage1, (int)ExpTypes.Fast)},

            {"Zubat", new PokemonInfo(0041, [40, 45, 35, 30, 40, 55], [(int)TypeIndex.Poison,(int)TypeIndex.Flying], [new MoveLvl("ConfuseRay"), new MoveLvl("Gust", 8), new MoveLvl("MegaDrain", 16), new MoveLvl("PoisonSting", 24), new MoveLvl("Bite", 32), new MoveLvl("Toxic", 40), new MoveLvl("AirSlash", 48)], [(int)EggGroups.Flying], 0.8f, 7.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"Paras", new PokemonInfo(0046, [35, 70, 55, 45, 55, 25], [(int)TypeIndex.Bug,(int)TypeIndex.Grass], [new MoveLvl("Tackle"), new MoveLvl("PoisonPowder", 6), new MoveLvl("VineWhip", 11), new MoveLvl("FuryCutter", 17), new MoveLvl("Slash", 27), new MoveLvl("GigaDrain", 38), new MoveLvl("EnergyBall", 47), new MoveLvl("LeafBlade", 49)], [(int)EggGroups.Bug, (int)EggGroups.Grass], 0.3f, 5.4f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Parasect", new PokemonInfo(0047, [60, 95, 80, 60, 80, 30], [(int)TypeIndex.Bug,(int)TypeIndex.Grass], [new MoveLvl("Tackle", 1), new MoveLvl("PoisonPowder", 6), new MoveLvl("VineWhip", 11), new MoveLvl("FuryCutter", 17), new MoveLvl("Slash", 29), new MoveLvl("GigaDrain", 44), new MoveLvl("EnergyBall", 47), new MoveLvl("LeafBlade", 59)], [(int)EggGroups.Bug, (int)EggGroups.Grass], 1.0f, 29.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            ...
            {"Diglett", new PokemonInfo(0050, [10, 55, 25, 35, 45, 95], [(int)TypeIndex.Ground], [new MoveLvl("Tackle"), new MoveLvl("MudSlap", 9), new MoveLvl("Dig", 17), new MoveLvl("RockThrow", 25), new MoveLvl("Slash", 33), new MoveLvl("Earthquake", 41)], [(int)EggGroups.Field], 0.2f, 0.8f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Dugtrio", new PokemonInfo(0051, [35, 100, 50, 50, 70, 120], [(int)TypeIndex.Ground], [new MoveLvl("Tackle", 1), new MoveLvl("MudSlap", 9), new MoveLvl("Dig", 17), new MoveLvl("RockThrow", 25), new MoveLvl("Slash", 37), new MoveLvl("Earthquake", 49)], [(int)EggGroups.Field], 0.7f, 33.3f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},

            {"Meowth", new PokemonInfo(0052, [40, 45, 35, 40, 40, 90], [(int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("QuickAttack", 8), new MoveLvl("Bite", 16), new MoveLvl("Swift", 24), new MoveLvl("Slash", 32), new MoveLvl("NightSlash", 40)], [(int)EggGroups.Field], 0.4f, 4.2f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"Poliwag", new PokemonInfo(0060, [40, 50, 40, 40, 40, 90], [(int)TypeIndex.Water], [new MoveLvl("Tackle"), new MoveLvl("WaterGun"), new MoveLvl("MudShot", 12), new MoveLvl("BubbleBeam", 18), new MoveLvl("Slam", 26), new MoveLvl("Earthquake", 36), new MoveLvl("HydroPump", 42), new MoveLvl("DoubleEdge", 54)], [(int)EggGroups.Water1], 0.6f, 12.4f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Poliwhirl", new PokemonInfo(0061, [65, 65, 65, 50, 50, 90], [(int)TypeIndex.Water], [new MoveLvl("Tackle", 1), new MoveLvl("WaterGun", 1), new MoveLvl("MudShot", 1), new MoveLvl("BubbleBeam", 1), new MoveLvl("Slam", 28), new MoveLvl("Earthquake", 40), new MoveLvl("HydroPump", 48), new MoveLvl("DoubleEdge", 66)], [(int)EggGroups.Water1], 1.0f, 20.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Poliwrath", new PokemonInfo(0062, [90, 95, 95, 70, 90, 70], [(int)TypeIndex.Water,(int)TypeIndex.Fighting], [new MoveLvl("BrickBreak"), new MoveLvl("Mudshot", 1), new MoveLvl("BubbleBeam", 1), new MoveLvl("Slam", 1)], [(int)EggGroups.Water1], 1.3f, 54.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            ...
            {"Kadabra", new PokemonInfo(0064, [40, 35, 30, 120, 70, 105], [(int)TypeIndex.Psychic], [new MoveLvl("Confusion"), new MoveLvl("Teleport"), new MoveLvl("Psybeam", 24), new MoveLvl("Recover", 30), new MoveLvl("PsychoCut", 34), new MoveLvl("Psychic", 40)], [(int)EggGroups.HumanLike], 1.3f, 56.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            {"Alakazam", new PokemonInfo(0065, [55, 50, 45, 135, 95, 120], [(int)TypeIndex.Psychic], [new MoveLvl("Confusion", 1), new MoveLvl("Teleport", 1), new MoveLvl("Psybeam", 24), new MoveLvl("Recover", 30), new MoveLvl("PsychoCut", 34), new MoveLvl("Psychic", 40)], [(int)EggGroups.HumanLike], 1.5f, 48.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow)},
            ...
            {"Bellsprout", new PokemonInfo(0069, [50, 75, 35, 70, 30, 40], [(int)TypeIndex.Grass,(int)TypeIndex.Poison], [new MoveLvl("VineWhip"), new MoveLvl("PoisonPowder", 12), new MoveLvl("ThunderWave", 17), new MoveLvl("PoisonSting", 23), new MoveLvl("Crunch", 29), new MoveLvl("RazorLeaf", 39), new MoveLvl("SludgeBomb", 41), new MoveLvl("Slam", 47)], [(int)EggGroups.Grass], 0.7f, 4.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            ...
            {"Shellder", new PokemonInfo(0090, [30, 65, 100, 45, 25, 40], [(int)TypeIndex.Water], [new MoveLvl("Tackle"), new MoveLvl("IceShard", 8), new MoveLvl("WaterGun", 12), new MoveLvl("Harden", 18), new MoveLvl("BubbleBeam", 24), new MoveLvl("Slash", 32), new MoveLvl("IceBeam", 40), new MoveLvl("HydroPump", 48)], [(int)EggGroups.Water3], 0.3f, 4.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow)},
            {"Cloyster", new PokemonInfo(0091, [50, 95, 180, 85, 45, 70], [(int)TypeIndex.Water,(int)TypeIndex.Ice], [new MoveLvl("IceFang"), new MoveLvl("Tackle", 1), new MoveLvl("IceShard", 8), new MoveLvl("WaterGun", 12), new MoveLvl("Harden", 18), new MoveLvl("BubbleBeam", 24), new MoveLvl("Slash", 32), new MoveLvl("IceBeam", 40), new MoveLvl("HydroPump", 48)], [(int)EggGroups.Water3], 1.5f, 132.5f, (int)StageIndex.Stage1, (int)ExpTypes.Slow)},
            ...
            {"Onix", new PokemonInfo(0095, [35, 45, 160, 30, 45, 70], [(int)TypeIndex.Rock,(int)TypeIndex.Ground], [new MoveLvl("Tackle"), new MoveLvl("Harden"), new MoveLvl("RockThrow", 8), new MoveLvl("DragonBreath", 12), new MoveLvl("RockSlide", 20), new MoveLvl("MudShot", 28), new MoveLvl("Slam", 36), new MoveLvl("Dig", 40), new MoveLvl("StoneEdge", 48), new MoveLvl("DoubleEdge", 56)], [(int)EggGroups.Mineral], 8.8f, 210.0f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"Krabby", new PokemonInfo(0098, [30, 105, 90, 25, 25, 50], [(int)TypeIndex.Water], [new MoveLvl("WaterGun"), new MoveLvl("Harden", 4), new MoveLvl("MudShot", 12), new MoveLvl("BubbleBeam", 20), new MoveLvl("Slash", 28), new MoveLvl("Slam", 36), new MoveLvl("Waterfall", 44)], [(int)EggGroups.Water3], 0.4f, 6.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"Lickitung", new PokemonInfo(0108, [90, 55, 75, 60, 75, 30], [(int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("Slam", 48)], [(int)EggGroups.Monster], 1.2f, 65.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Staryu", new PokemonInfo(0120, [30, 45, 55, 70, 55, 85], [(int)TypeIndex.Water], [new MoveLvl("Tackle"), new MoveLvl("Harden"), new MoveLvl("WaterGun", 4), new MoveLvl("ConfuseRay", 8), new MoveLvl("RapidSpin", 12), new MoveLvl("Swift", 20), new MoveLvl("Psybeam", 24), new MoveLvl("PowerGem", 36), new MoveLvl("Psychic", 40), new MoveLvl("Recover", 48), new MoveLvl("CosmicPower", 52), new MoveLvl("HydroPump", 56)], [(int)EggGroups.Water3], 0.8f, 34.5f, (int)StageIndex.Basic, (int)ExpTypes.Slow)},
            {"Starmie", new PokemonInfo(0121, [60, 75, 85, 100, 85, 115], [(int)TypeIndex.Water,(int)TypeIndex.Psychic], [new MoveLvl("Psybeam")], [(int)EggGroups.Water3], 1.1f, 80.0f, (int)StageIndex.Stage1, (int)ExpTypes.Slow)},
            ...
            {"Jynx", new PokemonInfo(0124, [65, 50, 35, 115, 95, 95], [(int)TypeIndex.Ice,(int)TypeIndex.Psychic], [new MoveLvl("IceFang"), new MoveLvl("Slam", 40), new MoveLvl("Blizzard", 58)], [(int)EggGroups.HumanLike], 1.4f, 40.6f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"Eevee", new PokemonInfo(0133, [55, 55, 50, 45, 65, 55], [(int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("QuickAttack", 10), new MoveLvl("Swift", 20), new MoveLvl("Bite", 25), new MoveLvl("DoubleEdge", 50)], [(int)EggGroups.Field], 0.3f, 6.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            {"Vaporeon", new PokemonInfo(0134, [130, 65, 60, 110, 95, 65], [(int)TypeIndex.Water], [new MoveLvl("WaterGun"), new MoveLvl("Tackle", 1), new MoveLvl("Bite", 1), new MoveLvl("QuickAttack", 10), new MoveLvl("IceFang", 20), new MoveLvl("WaterPulse", 25), new MoveLvl("AquaRing", 30), new MoveLvl("Waterfall", 40), new MoveLvl("HydroPump", 50)], [(int)EggGroups.Field], 1.0f, 29.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            {"Jolteon", new PokemonInfo(0135, [65, 65, 60, 110, 95, 130], [(int)TypeIndex.Electric], [new MoveLvl("ThunderWave"), new MoveLvl("Tackle", 1), new MoveLvl("Bite", 1), new MoveLvl("QuickAttack", 10), new MoveLvl("DoubleKick", 20), new MoveLvl("Thunderbolt", 25), new MoveLvl("PinMissile", 30), new MoveLvl("Discharge", 40), new MoveLvl("Thunder", 50)], [(int)EggGroups.Field], 0.8f, 24.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},
            {"Flareon", new PokemonInfo(0136, [65, 130, 60, 95, 110, 65], [(int)TypeIndex.Fire], [new MoveLvl("Ember"), new MoveLvl("Tackle", 1), new MoveLvl("Swift", 1), new MoveLvl("QuickAttack", 10), new MoveLvl("Smokescreen", 20), new MoveLvl("Bite", 25), new MoveLvl("FlameWheel", 30), new MoveLvl("LavaPlume", 40), new MoveLvl("Overheat", 50)], [(int)EggGroups.Field], 0.9f, 25.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast)},

            {"Porygon", new PokemonInfo(0137, [65, 60, 70, 85, 75, 40], [(int)TypeIndex.Normal], [new MoveLvl("Tackle"), new MoveLvl("ThunderWave", 8), new MoveLvl("ElectroBall", 16), new MoveLvl("Psybeam", 24), new MoveLvl("Recover", 32), new MoveLvl("Discharge",40), new MoveLvl("Slam", 48), new MoveLvl("Thunder", 56)], [(int)EggGroups.Mineral], 0.8f, 36.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},

            {"Omanyte", new PokemonInfo(0138, [35, 40, 100, 90, 55, 35], [(int)TypeIndex.Rock,(int)TypeIndex.Water], [new MoveLvl("WaterGun"), new MoveLvl("MudShot", 25), new MoveLvl("AncientPower", 30), new MoveLvl("RockSlide", 46), new MoveLvl("HydroPump", 60)], [(int)EggGroups.Water1, (int)EggGroups.Water3], 0.4f, 7.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"Aerodactyl", new PokemonInfo(0142, [80, 105, 65, 60, 75, 130], [(int)TypeIndex.Rock,(int)TypeIndex.Flying], [new MoveLvl("AncientPower"), new MoveLvl("Bite"), new MoveLvl("WingAttack", 10), new MoveLvl("RockSlide", 24), new MoveLvl("Crunch", 30), new MoveLvl("HyperBeam", 55)], [(int)EggGroups.Flying], 1.8f, 59.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow)},
            ...
            {"Dratini", new PokemonInfo(0147, [41, 64, 45, 50, 50, 50], [(int)TypeIndex.Dragon], [new MoveLvl("Tackle"), new MoveLvl("ThunderWave", 5), new MoveLvl("Gust", 10), new MoveLvl("DragonTail", 15), new MoveLvl("Slam", 25), new MoveLvl("AquaTail", 31), new MoveLvl("WaterPulse", 35), new MoveLvl("DragonRush", 45), new MoveLvl("HyperBeam", 55)], [(int)EggGroups.Water1, (int)EggGroups.Dragon], 1.8f, 3.3f, (int)StageIndex.Basic, (int)ExpTypes.Slow)},
            {"Dragonair", new PokemonInfo(0148, [61, 84, 65, 70, 70, 70], [(int)TypeIndex.Dragon], [new MoveLvl("Tackle", 1), new MoveLvl("ThunderWave", 5), new MoveLvl("Gust", 10), new MoveLvl("DragonTail", 15), new MoveLvl("Slam", 25), new MoveLvl("AquaTail", 33), new MoveLvl("WaterPulse", 36), new MoveLvl("DragonRush", 48), new MoveLvl("HyperBeam", 60)], [(int)EggGroups.Water1, (int)EggGroups.Dragon], 4.0f, 16.5f, (int)StageIndex.Stage1, (int)ExpTypes.Slow)},
            {"Dragonite", new PokemonInfo(0149, [91, 134, 95, 100, 100, 80], [(int)TypeIndex.Dragon,(int)TypeIndex.Flying], [new MoveLvl("Hurricane"), new MoveLvl("Tackle", 1), new MoveLvl("ThunderWave", 5), new MoveLvl("Gust", 10), new MoveLvl("DragonTail", 15), new MoveLvl("Slam", 25), new MoveLvl("AquaTail", 33), new MoveLvl("WaterPulse", 36), new MoveLvl("DragonRush", 48), new MoveLvl("ExtremeSpeed", 50), new MoveLvl("HyperBeam", 64)], [(int)EggGroups.Water1, (int)EggGroups.Dragon], 2.2f, 210.0f, (int)StageIndex.Stage2, (int)ExpTypes.Slow)},
            ...
            {"Totodile", new PokemonInfo(0158, [50, 65, 64, 44, 48, 43], [(int)TypeIndex.Water], [new MoveLvl("Tackle"), new MoveLvl("WaterGun", 6), new MoveLvl("MudShot", 13), new MoveLvl("IceFang", 20), new MoveLvl("Crunch", 27), new MoveLvl("Slash", 34), new MoveLvl("AquaTail", 41), new MoveLvl("Waterfall", 43), new MoveLvl("FocusPunch", 48), new MoveLvl("HydroPump", 50)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 0.6f, 9.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow)},
            {"Croconaw", new PokemonInfo(0159, [65, 80, 80, 59, 63, 58], [(int)TypeIndex.Water], [new MoveLvl("Tackle", 1), new MoveLvl("WaterGun", 6), new MoveLvl("MudShot", 13), new MoveLvl("IceFang", 21), new MoveLvl("Crunch", 30), new MoveLvl("Slash", 39), new MoveLvl("AquaTail", 47), new MoveLvl("Waterfall", 48), new MoveLvl("FocusPunch", 57), new MoveLvl("HydroPump", 60)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 1.1f, 25.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow)},
            ...
            {"Cleffa", new PokemonInfo(0173, [50, 25, 28, 45, 55, 15], [(int)TypeIndex.Fairy], [new MoveLvl("Tackle"), new MoveLvl("Harden", 8)], [(int)EggGroups.NoEggs], 0.3f, 3.0f, (int)StageIndex.Baby, (int)ExpTypes.Fast)},
            
            {"Igglybuff", new PokemonInfo(0174, [90, 30, 15, 40, 20, 15], [(int)TypeIndex.Normal,(int)TypeIndex.Fairy], [new MoveLvl("Tackle"), new MoveLvl("Harden", 8)], [(int)EggGroups.NoEggs], 0.3f, 1.0f, (int)StageIndex.Baby, (int)ExpTypes.Fast)},

            {"Mareep", new PokemonInfo(0179, [55, 40, 40, 65, 45, 35], [(int)TypeIndex.Electric], [new MoveLvl("Tackle")], [(int)EggGroups.Monster, (int)EggGroups.Field], 0.6f, 7.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, completed: false)},
            {"Flaaffy", new PokemonInfo(0180, [70, 55, 55, 80, 60, 45], [(int)TypeIndex.Electric], [new MoveLvl("Tackle")], [(int)EggGroups.Monster, (int)EggGroups.Field], 0.6f, 7.5f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, completed: false)},
            {"Ampharos", new PokemonInfo(0181, [90, 75, 75, 115, 90, 55], [(int)TypeIndex.Electric], [new MoveLvl("Tackle")], [(int)EggGroups.Monster, (int)EggGroups.Field], 0.6f, 7.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, completed: false)},
            ...
            {"Hoppip", new PokemonInfo(0187, [35, 35, 40, 35, 55, 50], [(int)TypeIndex.Grass, (int)TypeIndex.Flying], [new MoveLvl("Tackle"), new MoveLvl("RazorLeaf", 6), new MoveLvl("PoisonPowder", 9), new MoveLvl("AquaRing", 17), new MoveLvl("MagicalLeaf", 20), new MoveLvl("LeechSeed", 23), new MoveLvl("Slam", 31), new MoveLvl("HealPulse", 39), new MoveLvl("SolarBeam", 45)], [(int)EggGroups.Fairy, (int)EggGroups.Grass], 0.4f, 0.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumSlow, completed: false)},
            {"Skiploom", new PokemonInfo(0188, [55, 45, 50, 45, 65, 80], [(int)TypeIndex.Grass, (int)TypeIndex.Flying], [new MoveLvl("Tackle", 1), new MoveLvl("RazorLeaf", 6), new MoveLvl("PoisonPowder", 9), new MoveLvl("AquaRing", 18), new MoveLvl("MagicalLeaf", 22), new MoveLvl("LeechSeed", 26), new MoveLvl("Slam", 36), new MoveLvl("HealPulse", 46), new MoveLvl("SolarBeam", 54)], [(int)EggGroups.Fairy, (int)EggGroups.Grass], 0.6f, 1.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumSlow, completed: false)},
            {"Jumpluff", new PokemonInfo(0189, [75, 55, 70, 55, 85, 110], [(int)TypeIndex.Grass, (int)TypeIndex.Flying], [new MoveLvl("LeafStorm"), new MoveLvl("Tackle", 1), new MoveLvl("RazorLeaf", 6), new MoveLvl("PoisonPowder", 9), new MoveLvl("AquaRing", 18), new MoveLvl("MagicalLeaf", 22), new MoveLvl("LeechSeed", 26), new MoveLvl("Slam", 40), new MoveLvl("HealPulse", 54), new MoveLvl("SolarBeam", 66), new MoveLvl("LeafBlade", 70)], [(int)EggGroups.Fairy, (int)EggGroups.Grass], 0.8f, 3.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumSlow, completed: false)},

            {"Wooper", new PokemonInfo(0194, [55, 45, 45, 25, 25, 15], [(int)TypeIndex.Water, (int)TypeIndex.Ground], [new MoveLvl("Tackle")], [(int)EggGroups.Water1, (int)EggGroups.Field], 0.4f, 8.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast, completed: false)},
            {"Quagsire", new PokemonInfo(0195, [95, 85, 85, 65, 65, 35], [(int)TypeIndex.Water, (int)TypeIndex.Ground], [new MoveLvl("Tackle")], [(int)EggGroups.Water1, (int)EggGroups.Field], 1.4f, 75.0f, (int)StageIndex.Stage1, (int)ExpTypes.MediumFast, completed: false)},
            ...
            {"SlowKing", new PokemonInfo(0199, [85, 75, 80, 100, 110, 30], [(int)TypeIndex.Water, (int)TypeIndex.Psychic], [new MoveLvl("Confusion", 1)], [(int)EggGroups.Monster, (int)EggGroups.Water1], 2.0f, 79.5f, (int)StageIndex.Stage2, (int)ExpTypes.MediumFast, completed: false)},
            ...
            //Gen 3
            {"Mawile", new PokemonInfo(0303, [50, 85, 85, 55, 55, 50], [(int)TypeIndex.Steel,(int)TypeIndex.Fairy], [new MoveLvl("Tackle"), new MoveLvl("Bite", 12), new MoveLvl("Harden", 20), new MoveLvl("Crunch", 28), new MoveLvl("FlashCannon", 36), new MoveLvl("DoubleEdge", 44)], [(int)EggGroups.HumanLike], 0.6f, 11.5f, (int)StageIndex.Basic, (int)ExpTypes.Fast)},

            {"Bagon", new PokemonInfo(0371, [45, 75, 60, 40, 30, 50], [(int)TypeIndex.Dragon], [new MoveLvl("Tackle"), new MoveLvl("ThunderWave", 5), new MoveLvl("Gust", 10), new MoveLvl("DragonTail", 15), new MoveLvl("Slam", 25), new MoveLvl("AquaTail", 31), new MoveLvl("WaterPulse", 35), new MoveLvl("DragonRush", 45), new MoveLvl("HyperBeam", 55)], [(int)EggGroups.Dragon], 0.6f, 42.1f, (int)StageIndex.Basic, (int)ExpTypes.Slow, completed: false)},
            ...
            //Gen 4
            {"Cranidos", new PokemonInfo(0408, [67, 125, 40, 30, 30, 58], [(int)TypeIndex.Rock], [new MoveLvl("Tackle"), new MoveLvl("Harden", 8), new MoveLvl("Bite", 16), new MoveLvl("Slam", 22), new MoveLvl("AncientPower", 28), new MoveLvl("PsychoCut", 35), new MoveLvl("DoubleEdge", 40), new MoveLvl("StoneEdge", 45)], [(int)EggGroups.Monster], 0.9f, 31.5f, (int)StageIndex.Basic, (int)ExpTypes.Erratic)},
            {"Rampardos", new PokemonInfo(0409, [97, 165, 60, 65, 50, 58], [(int)TypeIndex.Rock], [new MoveLvl("Crunch"), new MoveLvl("Tackle", 1), new MoveLvl("Harden", 8), new MoveLvl("Bite", 16), new MoveLvl("Slam", 22), new MoveLvl("AncientPower", 28), new MoveLvl("PsychoCut", 38), new MoveLvl("DoubleEdge", 46), new MoveLvl("StoneEdge", 54)], [(int)EggGroups.Monster], 1.6f, 102.5f, (int)StageIndex.Stage1, (int)ExpTypes.Erratic)},
            
            {"Magnezone", new PokemonInfo(0462, [70, 70, 115, 130, 90, 60], [(int)TypeIndex.Electric,(int)TypeIndex.Steel], [new MoveLvl("Thunderbolt"), new MoveLvl("Tackle", 1), new MoveLvl("ConfuseRay", 1), new MoveLvl("ThunderWave", 1), new MoveLvl("ElectroBall", 12), new MoveLvl("Swift", 20), new MoveLvl("FlashCannon", 28), new MoveLvl("Discharge", 40), new MoveLvl("Thunder", 52)], [(int)EggGroups.Mineral], 1.2f, 180.0f, (int)StageIndex.Stage2, (int)ExpTypes.MediumFast)},
            ...
            {"CharizardMegaX", new PokemonInfo(0006, [78, 130, 111, 130, 85, 100], [(int)TypeIndex.Fire,(int)TypeIndex.Dragon], [new MoveLvl("DragonRush")], [(int)EggGroups.NoEggs], 1.7f, 110.5f, (int)StageIndex.Mega, (int)ExpTypes.MediumSlow)},
            ...
            {"TerrarianKabuto", new PokemonInfo(0140, [30, 70, 80, 65, 45, 65], [(int)TypeIndex.Rock,(int)TypeIndex.Ghost], [new MoveLvl("Harden"), new MoveLvl("Tackle", 5), new MoveLvl("ConfuseRay", 15), new MoveLvl("NightSlash", 25), new MoveLvl("AncientPower", 30), new MoveLvl("RockSlide", 42), new MoveLvl("FuryCutter", 47), new MoveLvl("ShadowBall", 52)], [(int)EggGroups.Amorphous], 0.5f, 1.5f, (int)StageIndex.Basic, (int)ExpTypes.MediumFast)},
            ...
            {"TerrarianAerodactyl", new PokemonInfo(0142, [80, 90, 65, 95, 75, 110], [(int)TypeIndex.Dark,(int)TypeIndex.Flying], [new MoveLvl("NightSlash"), new MoveLvl("Gust"), new MoveLvl("AncientPower", 10), new MoveLvl("Crunch", 20), new MoveLvl("DragonBreath", 30), new MoveLvl("NightShade", 40), new MoveLvl("Flamethrower", 50), new MoveLvl("AirSlash", 60), new MoveLvl("HyperBeam", 70)], [(int)EggGroups.Flying], 1.8f, 59.0f, (int)StageIndex.Basic, (int)ExpTypes.Slow)},
        };
