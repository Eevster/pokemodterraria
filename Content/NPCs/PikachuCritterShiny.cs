...
using Pokemod.Content.Pets.PikachuPetShiny;
...
namespace Pokemod.Content.NPCs
{
	...
	/// </summary>
	public class PikachuCritterNPCShiny : ModNPC
	{
		...
		public override void SetDefaults() {
			...
			NPC.catchItem = ModContent.ItemType<PikachuPetItemShiny>();
			NPC.lavaImmune = true;
			AIType = ClonedNPCID;
        ...
        {
			NPC.GetGlobalNPC<PokemonNPCData>().SetPokemonNPCData("Pikachu", true);
        }
	...
	public class PikachuCritterItemShiny : ModItem
	{
		public override void SetStaticDefaults() {
		...
		public override void SetDefaults() {
			...
			Item.makeNPC = ModContent.NPCType<PikachuCritterNPCShiny>();
