...
{
	public class SeelPetProjectile : PokemonPetProjectile
	{
		...
		public override string[] evolutions => ["Dewgong"];
		public override int levelToEvolve => 34;
	...
	public class SeelPetProjectileShiny : SeelPetProjectile{}
}
