...
{
	public class GrowlithePetProjectile : PokemonPetProjectile
	{
        ...
        public override string[] evolutions => ["Arcanine"];
        public override string[] itemToEvolve => ["FireStoneItem"];
	}

	public class GrowlithePetProjectileShiny : GrowlithePetProjectile{}
}
