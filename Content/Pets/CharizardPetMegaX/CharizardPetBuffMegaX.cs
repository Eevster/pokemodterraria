...
{
	public class CharizardPetBuffMegaX : ModBuff
	{
        ...
        {
            bool unused = false;
            player.BuffHandle_SpawnPetIfNeededAndSetTime(buffIndex, ref unused, ModContent.ProjectileType<CharizardPetProjectileMegaX>());
            ...
            if (player.HasBuff(Type))
            {
                ...
                player.AddBuff(BuffID.NebulaUpDmg3, 60);
            }
        }
	}
}
