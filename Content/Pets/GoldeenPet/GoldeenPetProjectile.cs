...
{
	public class GoldeenPetProjectile : PokemonPetProjectile
	{
		...
		public override string[] evolutions => ["Seaking"];
	...
	public class GoldeenPetProjectileShiny : GoldeenPetProjectile{}
}
