...
{
	public class GloomPetProjectile : PokemonPetProjectile
	{
        ...
        public override string[] evolutions => ["Vileplume"];
        public override string[] itemToEvolve => ["LeafStoneItem"];
	}

	public class GloomPetProjectileShiny : GloomPetProjectile{}
}
