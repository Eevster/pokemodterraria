...
{
	public class DrowzeePetProjectile : PokemonPetProjectile
	{
		...
		public override string[] evolutions => ["Hypno"];
	...
	public class DrowzeePetProjectileShiny : DrowzeePetProjectile{}
}
