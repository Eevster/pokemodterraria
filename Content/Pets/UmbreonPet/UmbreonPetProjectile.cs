...
namespace Pokemod.Content.Pets.UmbreonPet
{
	public class UmbreonPetProjectile : PokemonPetProjectile
	{
	...
	public class UmbreonPetProjectileShiny : UmbreonPetProjectile{}
}
