...
namespace Pokemod.Content.Pets.HisuianElectrodePet
{
	public class HisuianElectrodePetProjectile : PokemonPetProjectile
	{
	...
	public class HisuianElectrodePetProjectileShiny : HisuianElectrodePetProjectile{}
}
