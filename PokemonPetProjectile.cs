...
namespace Pokemod.Content.Pets
{
    public abstract class PokemonPetProjectile : ModProjectile
    {
        ...
        public virtual int baseHP => 0;
        public virtual int baseDef => 0;
        ...
        public void SetPokemonLvl(int lvl)
        {
            ...
            {
                Main.NewText(GetType().Name.Replace("PetProjectileShiny", "PetProjectile").Replace("PetProjectile", "") + " grew to lvl " + lvl);
            }
            pokemonLvl = lvl;
        }
        ...
        public int getMaxHP()
        {
            // Hp stat scales with level
            

            // ((2 * baseHP + IV + (EV / 4) * Level) / 100) + Level + 10
            int done = ((2 * baseHP + 0 + (0 / 4) * pokemonLvl) / 100) + pokemonLvl + 10;
        ...
        public int calIncomingDmg()
        {
            ...
            int dmg = npcdmg - ((baseDef * pokemonLvl) / 75);
        ...
        {
            float quotient = (float)currentHp/ getMaxHP();// Creating a quotient that represents the difference of your currentResource vs your maximumResource, resulting in a float of 0-1f.
